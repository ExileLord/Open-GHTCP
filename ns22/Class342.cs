...
namespace ns22
{
	public class Class342 : IDisposable
	{
		...
		private readonly Class342.Class343[] class343_0;

		private readonly Stream stream_0;

		public void Dispose()
		{
			if (Class342.smethod_0(this.stream_0))
			{
				Class342.smethod_1(this.stream_0, this.interface14_0.Length, 0L);
				...
				Class342.smethod_2(this.stream_0, array, array2, 0L);
			}
		...
		public static void smethod_1(Stream stream_1, int int_0, long long_0)
		{
			if (!Class342.smethod_0(stream_1))
			{
		...
		public static void smethod_2(Stream stream_1, int[] int_0, int[] int_1, long long_0)
		{
			if (!Class342.smethod_0(stream_1))
			{
				throw new ApplicationException("UpdateFinalBlocks called with non-updateable stream");
			...
			Class342.smethod_3(stream_1, int_0, int_1);
			stream_1.Seek(position, SeekOrigin.Begin);
		}
