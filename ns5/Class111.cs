...
namespace ns5
{
	public class Class111
	{
		...
		private bool method_1()
		{
			...
			int num4 = Class111.int_31[num2 >> 3];
			int num5 = num3 >> 5;
			this.int_1 = ((((num3 & 248) == 80) ? 10 : num5) | (((num3 & Class111.int_33[num5]) != 0) ? 16 : 0));
			int num6 = num & 63;
			if (num6 >= 38)
			{
				throw new AC3Exception("Unknown rate");
			}
			this.int_3 = Class111.int_32[num6 >> 1] * 1000 >> num4;
			int num7 = num & 192;
			if (num7 != 0)
			{
				if (num7 != 64)
				{
					...
					this.int_4 = 6 * Class111.int_32[num6 >> 1];
				}
				else
				{
					this.int_2 = 44100 >> num4;
					this.int_4 = 2 * (320 * Class111.int_32[num6 >> 1] / 147 + (num6 & 1));
				}
			}
			else
			{
				this.int_2 = 48000 >> num4;
				this.int_4 = 4 * Class111.int_32[num6 >> 1];
			}
		...
		private void method_2()
		{
			...
			if (num >= Class111.int_31.Length)
			{
				throw new FFMpegException("Illegal half rate");
			}
			this.int_6 = Class111.int_31[num];
			...
			{
				this.double_5 = Class111.double_11[this.class115_0.method_2(2)];
			}
			this.double_6 = 0.0;
			if ((this.int_7 & 4) != 0)
			{
				this.double_6 = Class111.double_12[this.class115_0.method_2(2)];
			}
		...
		{
			int num = Class111.int_35[this.int_7];
			...
			if (this.class115_0.vmethod_1())
			{
				...
				if (this.class115_0.vmethod_1())
				{
					...
					this.int_11 = Class111.int_36[num3];
			...
			if (this.int_7 == 2 && this.class115_0.vmethod_1())
			{
				...
				while (Class111.int_37[num11++] < num10);
			}
			int num12 = 0;
			int num13 = 0;
			if (this.int_9 != 0)
			...
			if (this.int_7 == 2)
			{
				...
				do
				{
					...
					{
						num34 >>= 1;
						num31 = Class111.int_37[num32++];
					}
					else
					{
						num34 >>= 1;
						int num35 = Class111.int_37[num32++];
						if (num35 > num33)
						{
							num35 = num33;
						}
		...
		private void method_4(int int_45, int int_46, int[] int_47, int int_48, int int_49, int int_50, int int_51, int int_52, byte[] byte_10, byte[] byte_11)
		{
			...
			int num4 = Class111.int_38[this.int_17 >> 5 & 3];
			int num5 = Class111.int_39[this.int_17 >> 3 & 3];
			int[] array = Class111.int_41[this.int_5];
			if (int_46 == 2)
			{
				int_47 = Class111.int_42;
			}
			int num6 = Class111.int_40[this.int_17 & 7];
			...
			if (int_49 == 0)
			{
				...
				while (true)
				{
					...
					num9 -= num6;
					byte_11[i] = Class111.byte_9[156 + num9 + (int)(4 * byte_10[i])];
					i++;
					if (i >= 3)
					{
						if (i >= 7)
			...
			{
				int num10 = j;
				int num11 = (Class111.int_43[i - 20] < int_50) ? Class111.int_43[i - 20] : int_50;
				...
				while (j < num11)
				{
					...
					case -2:
						...
						break;
					case -1:
						num8 = num12 + Class111.int_44[-num13 >> 1];
						break;
					case 0:
						num8 += Class111.int_44[num13 >> 1];
						break;
					}
				}
				int_51 += num;
				...
				do
				{
					byte_11[j] = Class111.byte_9[156 + num9 + (int)(4 * byte_10[j])];
				}
				while (++j < num11);
			}
			while (j < int_50);
			...
			while (j < int_46)
			{
				...
				case 0:
					if (bool_5)
					{
						...
						double_24[int_45 + j] = (double)num5 * array[(int)byte_10[j]] * Class111.double_2;
					}
					else
					{
			...
			while (i < this.int_13)
			{
				...
				while (i < num3)
				{
					...
					case -1:
						...
						break;
					case 0:
						num5 = Class111.double_2 * this.double_13[(int)array2[i]];
		...
		private void method_11(double[] double_24, int int_45, double double_25, double double_26, double double_27)
		{
			...
			case 4:
				double_24[0] = double_25;
				double_24[1] = double_25;
				double_24[2] = double_25 * double_27 * Class111.double_2;
				double_24[3] = double_25;
				double_24[4] = double_25;
				return;
			case 5:
				...
				double_24[1] = double_25 * double_26;
				double_24[2] = double_25;
				double_24[3] = double_25 * double_27 * Class111.double_2;
				double_24[4] = double_25;
				return;
			case 6:
				double_24[0] = double_25;
		...
		static Class111()
		{
			Class111.double_0 = 2.0;
			Class111.double_1 = 1.4142135623730951;
			Class111.double_2 = 0.70710678118654757;
			Class111.double_3 = 0.59460355750136051;
			Class111.double_4 = 0.5;
			Class111.int_31 = new int[]
			{
				0,
				0,
				0,
			...
			Class111.int_42 = new int[50];
			Class111.int_41 = Class114.smethod_15();
			Class111.byte_9 = Class114.smethod_16();
			Class111.int_43 = Class114.smethod_17();
			Class111.int_44 = Class114.smethod_18();
		}
	}
}
