...
namespace ns5
{
	public class Ac3Class1
	{
		...
		private void method_3()
		{
			...
			if (num17 != 0)
			{
				...
				else
				{
					...
					{
						method_4(_int18, _int19, _int20, _int11, _int12, _int13, _int28 << 8, _int29 << 8, _byte0, _byte3);
					}
					for (var num27 = 0; num27 < num; num27++)
					{
						if ((num17 & 1 << num27) != 0)
						{
							method_4(_int21[num27], _int22[num27], _int23[num27], 0, 0, _int16[num27], 0, 0, _byte1[num27], _byte4[num27]);
						}
					}
			...
			{
				method_7(_double10, num29 + 256 * num30, _byte1[num30], _byte4[num30], _class1130, array4[num30], array2[num30], _int16[num30]);
				int num31;
				if ((_int9 >> num30 & 1) != 0)
				{
					if (!flag3)
		...
		private void method_4(int int45, int int46, int[] int47, int int48, int int49, int int50, int int51, int int52, byte[] byte10, byte[] byte11)
		{
		...
		private void method_7(double[] double24, int int45, byte[] byte10, byte[] byte11, Class113 class1131, double double25, bool bool5, int int46)
		{
		...
		private void method_9(int int45, double[] double24, double[] double25, int int46, Class113 class1131, bool[] bool5)
		{
