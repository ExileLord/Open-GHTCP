		...
		public override void vmethod_0()
		{
			...
			if (_class3180.method_6(text = "scripts\\guitar\\custom_menu\\guitar_custom_progression.qb"))
			{
				...
				for (var i = 0; i < 32; i++)
				{
					if (num >> i != 0)
					{
						_gh3Songlist0.method_4(text, @class.method_5(new StructurePointerRootNode("gh3_custom" + (i + 1) + "_songs"))).CustomBit = 1 << i;
						_gh3Songlist0.method_5(text, @class.method_5(new StructurePointerRootNode("custom" + (i + 1) + "_progression")));
					}
				}
			...
			_gh3Songlist0.method_6((StructureArrayNode)@class.method_5(new ArrayPointerRootNode("custom_menu_setlist_switcher_progressions_" + (_bool0 ? "gha" : "gh3"))).method_7());
		}
