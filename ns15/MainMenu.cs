	...
	public class MainMenu : Form
	{
		...
		private void RebuildSong_MenuItem_Click(object sender, EventArgs e)
		{
			...
			if (this.SongListBox.SelectedIndex >= 0 && (gH3Song = (GH3Song)this.SongListBox.Items[this.SongListBox.SelectedIndex]).editable && (songData = new SongData(gH3Song.name, false, false)).ShowDialog() == DialogResult.OK)
			{
				if (songData.bool_1)
				{
					Class250 @class = songData.method_1(this.class319_0, this.string_4);
					this.method_4(@class);
				...
				if (songData.bool_0)
				{
					Class248 class2 = songData.method_0(this.string_4);
		...
		{
			SongData songData = new SongData(this.gh3Songlist_0);
		...
		{
			bool flag = false;
			string[] files = Directory.GetFiles(this.string_4 + "music\\", "*.dat.xen", SearchOption.AllDirectories);
			for (int i = 0; i < files.Length; i++)
			{
				string text = files[i];
				string text2 = Class244.smethod_12(text);
				if (File.Exists(this.string_4 + "music\\" + text2 + ".fsb.xen") && File.Exists(this.string_4 + "songs\\" + text2 + "_song.pak.xen") && !this.gh3Songlist_0.method_3(text2) && !Class327.smethod_4(text2) && !GH3Songlist.IgnoreSongs.Contains(Class327.smethod_9(text2)))
				{
					try
					{
		...
		private void method_0()
		{
			...
			this.SongListBox.Items.AddRange(this.gh3Songlist_0.method_2());
		}
		...
		private void LoadChart_EditorBtn_Click(object sender, EventArgs e)
		{
			...
			if (!(text = Class244.smethod_16("Select the game track file.", "Any Supported Game Track Formats|*.qbc;*.dbc;*_song.pak.xen;*.mid;*.chart|GH3CP QB Based Chart File|*.qbc|GH3CP dB Based Chart File|*.dbc|GH3 Game Track file|*_song.pak.xen|GH standard Midi file|*.mid|dB standard or GH3CP Chart file|*.chart", true)).Equals(""))
			{
				...
				try
				{
					...
					{
						string str = Class244.smethod_13(text).Replace("_song.pak.xen", "");
						using (Class318 @class = new Class318(text, false))
						{
							...
							class2 = new Class362(str, @class.method_8("songs\\" + str + ".mid.qb"));
							goto IL_DA;
						}
					}
					if (text.EndsWith(".qbc"))
					{
						class2 = new Class362(text);
					}
					else if (text.EndsWith(".mid"))
					{
						class2 = new Class367(text).method_0().method_3();
					}
					else
					{
						class2 = new ChartParser(text).method_3();
					}
					IL_DA:;
				}
				catch (Exception ex)
				...
				this.SongName_EditorLbl.Text = class2.gh3Song_0.title;
				this.SelectedTrack_EditorBox.Items.Clear();
				foreach (string current in class2.dictionary_0.Keys)
				{
					this.SelectedTrack_EditorBox.Items.Add(current);
				}
				this.SongEditor_Control.method_11(class2);
				this.SelectedTrack_EditorBox.SelectedIndex = 0;
				this.Offset_EditorTxtBox.Text = string.Concat(class2.gh3Song_0.gem_offset);
			}
		}
		...
		{
			string text;
			if (!(text = Class244.smethod_16("Select the Guitar Audio track file.", "Any Supported Audio Formats|*.mp3;*.wav;*.ogg;*.flac|MPEG Layer-3 Audio File|*.mp3|Waveform Audio File|*.wav|Ogg Vorbis Audio File|*.ogg|FLAC Audio File|*.flac", true)).Equals(""))
			{
				this.SongEditor_Control.method_12(text);
			}
		}
		...
		private void SaveChart_MenuItem_Click(object sender, EventArgs e)
		{
			if (this.SongListBox.SelectedIndex >= 0)
			{
				...
				string text = Class244.smethod_16("Select where to save the song chart.", "GH3CP QB Based Chart File|*.qbc|GH3CP dB Based Chart File|*.dbc", false);
				if (!text.Equals("") && File.Exists(this.string_4 + "songs\\" + gH3Song.name + "_song.pak.xen"))
				{
					using (Class318 @class = new Class318(this.string_4 + "songs\\" + gH3Song.name + "_song.pak.xen", false))
					{
						if (text.EndsWith(".qbc"))
						{
							new Class362(gH3Song.name, @class.method_8("songs\\" + gH3Song.name + ".mid.qb")).method_3(text);
						}
						else
						{
							new Class362(gH3Song.name, @class.method_8("songs\\" + gH3Song.name + ".mid.qb")).method_1().WriteMethod1(text);
						}
						return;
					}
				}
		...
		private void SaveTGH_MenuItem_Click(object sender, EventArgs e)
		{
			if (this.TierBox.SelectedIndex >= 0)
			{
				...
				{
					@class = new Class374(this.gh3Songlist_0, (GH3Tier)this.TierBox.SelectedItem, text, this.string_4);
				}
				else
				{
					@class = new Class374(this.gh3Songlist_0, (GH3Tier)this.TierBox.SelectedItem, text);
				}
				@class.method_1();
			}
		}
		...
		private void TGHSwitch_MenuItem_Click(object sender, EventArgs e)
		{
			if (this.TierBox.SelectedIndex >= 0)
			{
				...
				try
				{
					...
					{
						@class = new Class374(this.gh3Songlist_0, gH3Tier, text, this.string_4);
					}
					else
					{
						@class = new Class374(this.gh3Songlist_0, gH3Tier, text);
					}
					@class.method_0();
		...
		{
			if (this.gh3Songlist_0.dictionary_0.ContainsKey(this.int_0))
			{
		...
		private void SaveSGH_MenuItem_Click(object sender, EventArgs e)
		{
			if (this.gh3Songlist_0.dictionary_0.ContainsKey(this.int_0))
			{
				string text = Class244.smethod_15("Select where to save the setlist.", "GH3CP Setlist File|*.sgh", false, this.SetlistTitle_TxtBox.Text);
				if (text.Equals(""))
				{
					return;
				}
				...
				{
					@class = new Class370(this.gh3Songlist_0, this.gh3Songlist_0.dictionary_0[this.int_0], text, this.string_4);
				}
				else
				{
					@class = new Class370(this.gh3Songlist_0, this.gh3Songlist_0.dictionary_0[this.int_0], text);
				}
				@class.method_1();
			}
		}
		...
		private void SGHSwitch_MenuItem_Click(object sender, EventArgs e)
		{
			if (this.gh3Songlist_0.dictionary_0.ContainsKey(this.int_0))
			{
				...
				try
				{
					...
					{
						@class = new Class370(this.gh3Songlist_0, gH3Setlist, text, this.string_4);
					}
					else
					{
						@class = new Class370(this.gh3Songlist_0, gH3Setlist, text);
					}
					@class.method_0();
				...
				{
					MessageBox.Show("File not compatible! Setlist Switch failed.", "Setlist Switching");
				}
			}
		}
		...
		private void MassImporter_MenuItem_Click(object sender, EventArgs e)
		{
			...
			for (int i = 0; i < array.Length; i++)
			{
				...
				try
				{
					List<string> list2 = Class244.smethod_18(text, "*.mid;*.chart;*.qbc;*.dbc", true);
					List<string> list3 = Class244.smethod_18(text, "*.wav;*.mp3;*.ogg", true);
					string[] files = Directory.GetFiles(text, "*.dat", SearchOption.TopDirectoryOnly);
					if (list2.Count != 0 && (list3.Count != 0 || files.Length != 0))
					{
						GH3Song gH3Song = this.bool_0 ? new GHASong() : new GH3Song();
						gH3Song.name = Class244.smethod_13(text).ToLower().Replace(" ", "").Replace('.', '_');
						...
						foreach (string current in list2)
						{
							try
							{
								...
								{
									@class = new Class362(current);
								}
								else if (current.EndsWith(".mid"))
								{
									@class = new Class367(current).method_0().method_3();
								}
								else
								{
									@class = new ChartParser(current).method_3();
								}
								break;
							}
							catch
						...
						if (@class != null)
						{
							...
							{
								SongData songData = new SongData(gH3Song.name, @class, class2, list3.ToArray());
								Class250 class3 = songData.method_1(this.class319_0, this.string_4);
								Class248 class4 = songData.method_0(this.string_4);
								gH3Song.vmethod_0(class3.class362_0.gh3Song_0);
								if (File.Exists(text + "\\song.ini"))
								{
									string[] array3 = File.ReadAllLines(text + "\\song.ini");
		...
		public MainMenu()
		{
			...
			if (!File.Exists(this.string_0 + "lame_enc.dll"))
			{
				try
				{
					Class199.smethod_8(new WebClient().OpenRead("http://spaghetticode.org/lame/libmp3lame-win-3.97.zip"), this.string_0 + "lame_enc.dll", "libmp3lame-3.97/lame_enc.dll");
				}
				catch
				{
					...
					try
					{
						...
						Class199.smethod_4(text4, this.string_0 + "lame_enc.dll", "libmp3lame" + text5.Substring(text5.LastIndexOf('-')) + "/lame_enc.dll");
						try
						{
		...
		{
			new TexExplorer(this.string_4).ShowDialog();
		}
		...
		{
			this.method_11(this.gh3Songlist_0.dictionary_0[this.int_0 = this.gh3Songlist_0.method_9((string)this.Setlist_DropBox.SelectedItem)]);
		}
		...
		private void CreateSetlist_Btn_Click(object sender, EventArgs e)
		{
			...
			for (int i = 0; ; )
			{
                ...
                if (!((this.gh3Songlist_0.CustomBitMask & num) == 0))
					...
					int num2;
					this.gh3Songlist_0.dictionary_0.Add(num2 = Class327.smethod_9("gh3_custom" + (i + 1) + "_songs"), gH3Setlist);
					int value;
		...
		{
			if (!this.gh3Songlist_0.dictionary_0[this.int_0].method_4())
			{
				return;
			}
		...
		{
			GH3Setlist gH3Setlist = this.gh3Songlist_0.dictionary_0[this.int_0];
		...
		private void InitializeComponent()
		{
			...
			this.rightClickMenu = new ContextMenuStrip(this.icontainer_0);
			this.SysHigh_MenuItem = new ToolStripMenuItem();
			this.SysAbove_MenuItem = new ToolStripMenuItem();
			this.SysNormal_MenuItem = new ToolStripMenuItem();
			this.SysBelow_MenuItem = new ToolStripMenuItem();
			this.toolStripSeparator8 = new ToolStripSeparator();
			this.MinToTray_MenuItem = new ToolStripMenuItem();
			this.SysExit_MenuItem = new ToolStripMenuItem();
			this.SongListBox = new Class238();
			this.TopMenuStrip = new MenuStrip();
			this.File_MenuItem = new ToolStripMenuItem();
			this.OpenGameSettings_MenuItem = new ToolStripMenuItem();
			this.RecoverGameSettings_MenuItem = new ToolStripMenuItem();
			this.ClearGameSettings_MenuItem = new ToolStripMenuItem();
			this.ExecuteActions_MenuItem = new ToolStripMenuItem();
			this.ClearActions_MenuItem = new ToolStripMenuItem();
			this.toolStripSeparator1 = new ToolStripSeparator();
			this.SaveTGH_MenuItem = new ToolStripMenuItem();
			this.SaveSGH_MenuItem = new ToolStripMenuItem();
			this.SaveChart_MenuItem = new ToolStripMenuItem();
			this.toolStripSeparator6 = new ToolStripSeparator();
			this.Exit_MenuItem = new ToolStripMenuItem();
			this.Add_MenuItem = new ToolStripMenuItem();
			this.NewSong_MenuItem = new ToolStripMenuItem();
			this.Tier_MenuItem = new ToolStripMenuItem();
			this.NewTier_MenuItem = new ToolStripMenuItem();
			this.TGHImport_MenuItem = new ToolStripMenuItem();
			this.MassImporter_MenuItem = new ToolStripMenuItem();
			this.LegacyImporter_MenuItem = new ToolStripMenuItem();
			this.RecoverSonglist_MenuItem = new ToolStripMenuItem();
			this.ManageGame_MenuItem = new ToolStripMenuItem();
			this.ManageTiers_MenuItem = new ToolStripMenuItem();
			this.toolStripSeparator4 = new ToolStripSeparator();
			this.TGHSwitch_MenuItem = new ToolStripMenuItem();
			this.SGHSwitch_MenuItem = new ToolStripMenuItem();
			this.toolStripSeparator11 = new ToolStripSeparator();
			this.GameSettingsSwitch_MenuItem = new ToolStripMenuItem();
			this.RestoreLast_MenuItem = new ToolStripMenuItem();
			this.RestoreOriginal_MenuItem = new ToolStripMenuItem();
			this.toolStripSeparator7 = new ToolStripSeparator();
			this.SaveFileControl_MenuItem = new ToolStripMenuItem();
			this.TexExplorer_MenuItem = new ToolStripMenuItem();
			this.FxSpeedBoost_MenuItem = new ToolStripMenuItem();
			this.ManageSongs_MenuItem = new ToolStripMenuItem();
			this.SongProps_MenuItem = new ToolStripMenuItem();
			this.RebuildSong_MenuItem = new ToolStripMenuItem();
			this.SilentGuitar_MenuItem = new ToolStripMenuItem();
			this.ForceMp3Conversion_MenuItem = new ToolStripMenuItem();
			this.DeleteSong_MenuItem = new ToolStripMenuItem();
			this.RemoveSong_ToolStripMenuItem = new ToolStripSeparator();
			this.HideUnEdit_MenuItem = new ToolStripMenuItem();
			this.HideUsed_MenuItem = new ToolStripMenuItem();
			this.ByTitle_MenuItem = new ToolStripMenuItem();
			this.Help_MenuItem = new ToolStripMenuItem();
			this.Guide_MenuItem = new ToolStripMenuItem();
			this.ScoreHero_MenuItem = new ToolStripMenuItem();
			this.GH3Folder_MenuItem = new ToolStripMenuItem();
			this.toolStripSeparator3 = new ToolStripSeparator();
			this.Disclaimer_MenuItem = new ToolStripMenuItem();
			this.About_MenuItem = new ToolStripMenuItem();
			this.ActionRequests_ListBox = new ListBox();
			...
			this.leftClickMenu = new ContextMenuStrip(this.icontainer_0);
			this.SysEnglish_MenuItem = new ToolStripMenuItem();
			this.SysFrench_MenuItem = new ToolStripMenuItem();
			this.SysItalian_MenuItem = new ToolStripMenuItem();
			this.SysSpanish_MenuItem = new ToolStripMenuItem();
			this.SysGerman_MenuItem = new ToolStripMenuItem();
			this.SysKorean_MenuItem = new ToolStripMenuItem();
			this.SongEditorTab = new TabPage();
			this.SongEditor_Container = new ToolStripContainer();
			this.SongEditor_BottomToolStrip = new ToolStrip();
			this.ToggleElements_EditorSplitBtn = new ToolStripSplitButton();
			this.StarView_EditorBtn = new ToolStripMenuItem();
			this.HopoView_EditorBtn = new ToolStripMenuItem();
			this.AudioView_EditorBtn = new ToolStripMenuItem();
			this.toolStripSeparator10 = new ToolStripSeparator();
			this.toolStripLabel1 = new ToolStripLabel();
			this.BeatSize_EditorTxtBox = new ToolStripTextBox();
			this.HyperSpeed_EditorBar = new Control0();
			this.FretAngle_EditorBar = new Control0();
			this.toolStripSeparator12 = new ToolStripSeparator();
			this.toolStripLabel2 = new ToolStripLabel();
			this.Offset_EditorTxtBox = new ToolStripTextBox();
			this.SongEditor_Control = new SongEditor();
			this.SongEditor_TopToolStrip = new ToolStrip();
			this.GameMode_EditorBtn = new ToolStripButton();
			this.toolStripSeparator5 = new ToolStripSeparator();
			this.LoadChart_EditorBtn = new ToolStripButton();
			this.SelectedTrack_EditorBox = new ToolStripComboBox();
			this.SongName_EditorLbl = new ToolStripLabel();
			this.toolStripSeparator2 = new ToolStripSeparator();
			this.LoadAudio_EditorBtn = new ToolStripButton();
			this.PlayPause_EditorBtn = new ToolStripButton();
			this.Stop_EditorBtn = new ToolStripButton();
			this.PlayTime_EditorLbl = new ToolStripLabel();
			this.SetlistTab = new TabPage();
			this.SetlistConfig_Container = new ToolStripContainer();
			this.SetlistConf_TLPanel = new TableLayoutPanel();
			this.Setlist_TLPanel = new TableLayoutPanel();
			this.textBox3 = new TextBox();
			this.label5 = new Label();
			this.label4 = new Label();
			this.TierBox = new ComboBox();
			this.SetlistInitMovie_TxtBox = new TextBox();
			this.SetlistPrefix_TxtBox = new TextBox();
			this.label2 = new Label();
			this.label13 = new Label();
			this.SetlistTitle_TxtBox = new TextBox();
			this.Tier_TLPanel = new TableLayoutPanel();
			this.TierProps_Panel = new Panel();
			this.TierUnlockedSet_Btn = new Button();
			this.UnlockAll_CheckBox = new CheckBox();
			this.NoCash_CheckBox = new CheckBox();
			this.TierApply_Btn = new Button();
			this.label12 = new Label();
			this.SetlistApply_Btn = new Button();
			this.TierCompMovie_TxtBox = new TextBox();
			this.TierUnlocked_NumBox = new NumericUpDown();
			this.TierTitle_TxtBox = new TextBox();
			this.TierIcon_DropBox = new ComboBox();
			this.TierStage_DropBox = new ComboBox();
			this.TierBoss_CheckBox = new CheckBox();
			this.TierEncorep2_CheckBox = new CheckBox();
			this.TierEncorep1_CheckBox = new CheckBox();
			this.label10 = new Label();
			this.label9 = new Label();
			this.label8 = new Label();
			this.label6 = new Label();
			this.label7 = new Label();
			this.TierSongs_Panel = new TableLayoutPanel();
			this.TierSongs_ListBox = new Class238();
			this.label11 = new Label();
			this.SetlistStrip = new ToolStrip();
			this.Setlist_Lbl = new ToolStripLabel();
			this.Setlist_DropBox = new ToolStripComboBox();
			this.CreateSetlist_Btn = new ToolStripButton();
			this.DeleteSetlist_Btn = new ToolStripButton();
			this.SettingsTab = new TabPage();
			this.TabControl = new TabControl();
			this.MainContainer = new ToolStripContainer();
			this.StatusStrip = new StatusStrip();
			this.ToolStripStatusLbl = new ToolStripStatusLabel();
			...
			((ISupportInitialize)this.TierUnlocked_NumBox).BeginInit();
			...
			this.SysExit_MenuItem.Size = new Size(166, 22);
			this.SysExit_MenuItem.Text = "Exit";
			this.SysExit_MenuItem.Click += new EventHandler(this.Exit_MenuItem_Click);
			this.SongListBox.AllowDrop = true;
			this.SongListBox.method_4(false);
			this.SongListBox.Dock = DockStyle.Fill;
			...
			this.SongListBox.Location = new Point(0, 20);
			this.SongListBox.Margin = new Padding(0);
			this.SongListBox.Name = "SongListBox";
			this.SongListBox.ScrollAlwaysVisible = true;
			this.SongListBox.SelectionMode = SelectionMode.MultiExtended;
			this.SongListBox.Size = new Size(180, 354);
			this.SongListBox.Sorted = true;
			this.SongListBox.TabIndex = 1;
			this.SongListBox.SelectedIndexChanged += new EventHandler(this.SongListBox_SelectedIndexChanged);
			this.SongListBox.KeyDown += new KeyEventHandler(this.SongListBox_KeyDown);
			this.SongListBox.MouseDown += new MouseEventHandler(this.SongListBox_MouseDown);
			this.TopMenuStrip.Dock = DockStyle.None;
			this.TopMenuStrip.Items.AddRange(new ToolStripItem[]
			{
				this.File_MenuItem,
				this.Add_MenuItem,
			...
			this.TopMenuStrip.Location = new Point(0, 0);
			this.TopMenuStrip.Name = "TopMenuStrip";
			this.TopMenuStrip.Size = new Size(784, 24);
			this.TopMenuStrip.TabIndex = 2;
			this.TopMenuStrip.Text = "menuStrip1";
			this.File_MenuItem.DropDownItems.AddRange(new ToolStripItem[]
			{
			...
			this.File_MenuItem.Size = new Size(37, 20);
			this.File_MenuItem.Text = "File";
			this.OpenGameSettings_MenuItem.Name = "OpenGameSettings_MenuItem";
			this.OpenGameSettings_MenuItem.ShortcutKeys = (Keys)131151;
			this.OpenGameSettings_MenuItem.Size = new Size(241, 22);
			this.OpenGameSettings_MenuItem.Text = "&Open Game Settings";
			this.OpenGameSettings_MenuItem.Click += new EventHandler(this.OpenGameSettings_MenuItem_Click);
			this.RecoverGameSettings_MenuItem.Name = "RecoverGameSettings_MenuItem";
			this.RecoverGameSettings_MenuItem.ShortcutKeys = (Keys)131154;
			this.RecoverGameSettings_MenuItem.Size = new Size(241, 22);
			this.RecoverGameSettings_MenuItem.Text = "&Recover Game Settings";
			this.RecoverGameSettings_MenuItem.Click += new EventHandler(this.RecoverGameSettings_MenuItem_Click);
			this.ClearGameSettings_MenuItem.Name = "ClearGameSettings_MenuItem";
			this.ClearGameSettings_MenuItem.ShortcutKeys = (Keys)131153;
			this.ClearGameSettings_MenuItem.Size = new Size(241, 22);
			this.ClearGameSettings_MenuItem.Text = "Clear Game Settings";
			this.ClearGameSettings_MenuItem.Click += new EventHandler(this.ClearGameSettings_MenuItem_Click);
			this.ExecuteActions_MenuItem.Name = "ExecuteActions_MenuItem";
			this.ExecuteActions_MenuItem.ShortcutKeys = (Keys)393299;
			this.ExecuteActions_MenuItem.Size = new Size(241, 22);
			this.ExecuteActions_MenuItem.Text = "Execute &Actions";
			this.ExecuteActions_MenuItem.Click += new EventHandler(this.ExecuteActions_MenuItem_Click);
			this.ClearActions_MenuItem.Name = "ClearActions_MenuItem";
			this.ClearActions_MenuItem.ShortcutKeys = (Keys)393297;
			this.ClearActions_MenuItem.Size = new Size(241, 22);
			this.ClearActions_MenuItem.Text = "&Clear Actions";
			this.ClearActions_MenuItem.Click += new EventHandler(this.ClearActions_MenuItem_Click);
			this.toolStripSeparator1.Name = "toolStripSeparator1";
			this.toolStripSeparator1.Size = new Size(238, 6);
			this.SaveTGH_MenuItem.Name = "SaveTGH_MenuItem";
			this.SaveTGH_MenuItem.ShortcutKeys = (Keys)327763;
			this.SaveTGH_MenuItem.Size = new Size(241, 22);
			this.SaveTGH_MenuItem.Text = "Export &TGH (Tier)";
			this.SaveTGH_MenuItem.Click += new EventHandler(this.SaveTGH_MenuItem_Click);
			this.SaveSGH_MenuItem.Name = "SaveSGH_MenuItem";
			this.SaveSGH_MenuItem.ShortcutKeys = (Keys)262227;
			this.SaveSGH_MenuItem.Size = new Size(241, 22);
			this.SaveSGH_MenuItem.Text = "Export &SGH (Setlist)";
			this.SaveSGH_MenuItem.Click += new EventHandler(this.SaveSGH_MenuItem_Click);
			this.SaveChart_MenuItem.Name = "SaveChart_MenuItem";
			this.SaveChart_MenuItem.ShortcutKeys = (Keys)196691;
			this.SaveChart_MenuItem.Size = new Size(241, 22);
			this.SaveChart_MenuItem.Text = "Export Song Chart";
			this.SaveChart_MenuItem.Click += new EventHandler(this.SaveChart_MenuItem_Click);
			this.toolStripSeparator6.Name = "toolStripSeparator6";
			this.toolStripSeparator6.Size = new Size(238, 6);
			this.Exit_MenuItem.Name = "Exit_MenuItem";
			this.Exit_MenuItem.ShortcutKeys = (Keys)262225;
			this.Exit_MenuItem.Size = new Size(241, 22);
			this.Exit_MenuItem.Text = "&Exit";
			this.Exit_MenuItem.Click += new EventHandler(this.Exit_MenuItem_Click);
			this.Add_MenuItem.DropDownItems.AddRange(new ToolStripItem[]
			{
			...
			this.Add_MenuItem.Size = new Size(41, 20);
			this.Add_MenuItem.Text = "Add";
			this.NewSong_MenuItem.Name = "NewSong_MenuItem";
			this.NewSong_MenuItem.ShortcutKeys = (Keys)262222;
			this.NewSong_MenuItem.Size = new Size(167, 22);
			this.NewSong_MenuItem.Text = "New Song";
			this.NewSong_MenuItem.Click += new EventHandler(this.NewSong_MenuItem_Click);
			this.Tier_MenuItem.DropDownItems.AddRange(new ToolStripItem[]
			{
				this.NewTier_MenuItem,
				this.TGHImport_MenuItem
			});
			this.Tier_MenuItem.Name = "Tier_MenuItem";
			this.Tier_MenuItem.Size = new Size(167, 22);
			this.Tier_MenuItem.Text = "Tier";
			this.NewTier_MenuItem.Name = "NewTier_MenuItem";
			this.NewTier_MenuItem.ShortcutKeys = (Keys)262228;
			this.NewTier_MenuItem.Size = new Size(137, 22);
			this.NewTier_MenuItem.Text = "New";
			this.NewTier_MenuItem.Click += new EventHandler(this.NewTier_MenuItem_Click);
			this.TGHImport_MenuItem.Name = "TGHImport_MenuItem";
			this.TGHImport_MenuItem.Size = new Size(137, 22);
			this.TGHImport_MenuItem.Text = "TGH Import";
			this.TGHImport_MenuItem.Click += new EventHandler(this.TGHImport_MenuItem_Click);
			this.MassImporter_MenuItem.Name = "MassImporter_MenuItem";
			this.MassImporter_MenuItem.Size = new Size(167, 22);
			this.MassImporter_MenuItem.Text = "Mass Importer";
			this.MassImporter_MenuItem.Click += new EventHandler(this.MassImporter_MenuItem_Click);
			this.LegacyImporter_MenuItem.Enabled = false;
			this.LegacyImporter_MenuItem.Name = "LegacyImporter_MenuItem";
			this.LegacyImporter_MenuItem.Size = new Size(167, 22);
			this.LegacyImporter_MenuItem.Text = "Legacy Importer";
			this.LegacyImporter_MenuItem.Click += new EventHandler(this.LegacyImporter_MenuItem_Click);
			this.RecoverSonglist_MenuItem.Name = "RecoverSonglist_MenuItem";
			this.RecoverSonglist_MenuItem.Size = new Size(167, 22);
			this.RecoverSonglist_MenuItem.Text = "Recover Songlist";
			this.RecoverSonglist_MenuItem.Click += new EventHandler(this.RecoverSonglist_MenuItem_Click);
			this.ManageGame_MenuItem.DropDownItems.AddRange(new ToolStripItem[]
			{
			...
			this.ManageGame_MenuItem.Size = new Size(124, 20);
			this.ManageGame_MenuItem.Text = "Game Management";
			this.ManageTiers_MenuItem.Name = "ManageTiers_MenuItem";
			this.ManageTiers_MenuItem.ShortcutKeys = (Keys)131156;
			this.ManageTiers_MenuItem.Size = new Size(237, 22);
			this.ManageTiers_MenuItem.Text = "Manage Tiers";
			this.ManageTiers_MenuItem.Click += new EventHandler(this.ManageTiers_MenuItem_Click);
			this.toolStripSeparator4.Name = "toolStripSeparator4";
			this.toolStripSeparator4.Size = new Size(234, 6);
			this.TGHSwitch_MenuItem.Name = "TGHSwitch_MenuItem";
			this.TGHSwitch_MenuItem.Size = new Size(237, 22);
			this.TGHSwitch_MenuItem.Text = "TGH Tier Switch";
			this.TGHSwitch_MenuItem.Click += new EventHandler(this.TGHSwitch_MenuItem_Click);
			this.SGHSwitch_MenuItem.Name = "SGHSwitch_MenuItem";
			this.SGHSwitch_MenuItem.Size = new Size(237, 22);
			this.SGHSwitch_MenuItem.Text = "SGH Setlist Switch";
			this.SGHSwitch_MenuItem.Click += new EventHandler(this.SGHSwitch_MenuItem_Click);
			this.toolStripSeparator11.Name = "toolStripSeparator11";
			this.toolStripSeparator11.Size = new Size(234, 6);
			this.GameSettingsSwitch_MenuItem.Name = "GameSettingsSwitch_MenuItem";
			this.GameSettingsSwitch_MenuItem.Size = new Size(237, 22);
			this.GameSettingsSwitch_MenuItem.Text = "Game Settings Switch";
			this.GameSettingsSwitch_MenuItem.Click += new EventHandler(this.GameSettingsSwitch_MenuItem_Click);
			this.RestoreLast_MenuItem.Name = "RestoreLast_MenuItem";
			this.RestoreLast_MenuItem.Size = new Size(237, 22);
			this.RestoreLast_MenuItem.Text = "Restore Last Game Settings";
			this.RestoreLast_MenuItem.Click += new EventHandler(this.RestoreLast_MenuItem_Click);
			this.RestoreOriginal_MenuItem.Name = "RestoreOriginal_MenuItem";
			this.RestoreOriginal_MenuItem.Size = new Size(237, 22);
			this.RestoreOriginal_MenuItem.Text = "Restore Original Game Settings";
			this.RestoreOriginal_MenuItem.Click += new EventHandler(this.RestoreOriginal_MenuItem_Click);
			this.toolStripSeparator7.Name = "toolStripSeparator7";
			this.toolStripSeparator7.Size = new Size(234, 6);
			this.SaveFileControl_MenuItem.Name = "SaveFileControl_MenuItem";
			this.SaveFileControl_MenuItem.ShortcutKeys = (Keys)131155;
			this.SaveFileControl_MenuItem.Size = new Size(237, 22);
			this.SaveFileControl_MenuItem.Text = "Save File Patcher";
			this.SaveFileControl_MenuItem.Click += new EventHandler(this.SaveFileControl_MenuItem_Click);
			this.TexExplorer_MenuItem.Name = "TexExplorer_MenuItem";
			this.TexExplorer_MenuItem.ShortcutKeys = (Keys)131145;
			this.TexExplorer_MenuItem.Size = new Size(237, 22);
			this.TexExplorer_MenuItem.Text = "Texture Explorer";
			this.TexExplorer_MenuItem.Click += new EventHandler(this.TexExplorer_MenuItem_Click);
			this.FxSpeedBoost_MenuItem.Name = "FxSpeedBoost_MenuItem";
			this.FxSpeedBoost_MenuItem.Size = new Size(237, 22);
			this.FxSpeedBoost_MenuItem.Text = "FX Speed Boost";
			this.FxSpeedBoost_MenuItem.Click += new EventHandler(this.FxSpeedBoost_MenuItem_Click);
			this.ManageSongs_MenuItem.DropDownItems.AddRange(new ToolStripItem[]
			{
			...
			this.ManageSongs_MenuItem.Size = new Size(135, 20);
			this.ManageSongs_MenuItem.Text = "Songlist Management";
			this.SongProps_MenuItem.Name = "SongProps_MenuItem";
			this.SongProps_MenuItem.ShortcutKeys = (Keys)131152;
			this.SongProps_MenuItem.Size = new Size(221, 22);
			this.SongProps_MenuItem.Text = "Edit Song Properties";
			this.SongProps_MenuItem.Click += new EventHandler(this.SongProps_MenuItem_Click);
			this.RebuildSong_MenuItem.Name = "RebuildSong_MenuItem";
			this.RebuildSong_MenuItem.ShortcutKeys = (Keys)131140;
			this.RebuildSong_MenuItem.Size = new Size(221, 22);
			this.RebuildSong_MenuItem.Text = "Rebuild Song Data";
			this.RebuildSong_MenuItem.Click += new EventHandler(this.RebuildSong_MenuItem_Click);
			this.SilentGuitar_MenuItem.Name = "SilentGuitar_MenuItem";
			this.SilentGuitar_MenuItem.Size = new Size(221, 22);
			this.SilentGuitar_MenuItem.Text = "Silent Guitar Track";
			this.SilentGuitar_MenuItem.Click += new EventHandler(this.SilentGuitar_MenuItem_Click);
			this.ForceMp3Conversion_MenuItem.Name = "ForceMp3Conversion_MenuItem";
			this.ForceMp3Conversion_MenuItem.Size = new Size(221, 22);
			this.ForceMp3Conversion_MenuItem.Text = "Force Mp3 Conversion";
			this.ForceMp3Conversion_MenuItem.Click += new EventHandler(this.ForceMp3Conversion_MenuItem_Click);
			this.DeleteSong_MenuItem.Name = "DeleteSong_MenuItem";
			this.DeleteSong_MenuItem.Size = new Size(221, 22);
			this.DeleteSong_MenuItem.Text = "Delete Song";
			this.DeleteSong_MenuItem.Click += new EventHandler(this.DeleteSong_MenuItem_Click);
			this.RemoveSong_ToolStripMenuItem.Name = "RemoveSong_ToolStripMenuItem";
			this.RemoveSong_ToolStripMenuItem.Size = new Size(218, 6);
			this.HideUnEdit_MenuItem.Name = "HideUnEdit_MenuItem";
			this.HideUnEdit_MenuItem.ShortcutKeys = (Keys)262223;
			this.HideUnEdit_MenuItem.Size = new Size(221, 22);
			this.HideUnEdit_MenuItem.Text = "Hide Original Songs";
			this.HideUnEdit_MenuItem.Click += new EventHandler(this.HideUnEdit_MenuItem_Click);
			this.HideUsed_MenuItem.Name = "HideUsed_MenuItem";
			this.HideUsed_MenuItem.ShortcutKeys = (Keys)262216;
			this.HideUsed_MenuItem.Size = new Size(221, 22);
			this.HideUsed_MenuItem.Text = "Hide Used Songs";
			this.HideUsed_MenuItem.Click += new EventHandler(this.HideUsed_MenuItem_Click);
			this.ByTitle_MenuItem.Name = "ByTitle_MenuItem";
			this.ByTitle_MenuItem.ShortcutKeys = (Keys)262212;
			this.ByTitle_MenuItem.Size = new Size(221, 22);
			this.ByTitle_MenuItem.Text = "Display By Title";
			this.ByTitle_MenuItem.Click += new EventHandler(this.ByTitle_MenuItem_Click);
			this.Help_MenuItem.DropDownItems.AddRange(new ToolStripItem[]
			{
				this.Guide_MenuItem,
			...
			this.Help_MenuItem.Size = new Size(44, 20);
			this.Help_MenuItem.Text = "Help";
			this.Guide_MenuItem.Name = "Guide_MenuItem";
			this.Guide_MenuItem.ShortcutKeys = Keys.F1;
			this.Guide_MenuItem.Size = new Size(154, 22);
			this.Guide_MenuItem.Text = "Guide";
			this.Guide_MenuItem.Click += new EventHandler(this.Guide_MenuItem_Click);
			this.ScoreHero_MenuItem.Name = "ScoreHero_MenuItem";
			this.ScoreHero_MenuItem.ShortcutKeys = Keys.F2;
			this.ScoreHero_MenuItem.Size = new Size(154, 22);
			this.ScoreHero_MenuItem.Text = "Score Hero";
			this.ScoreHero_MenuItem.Click += new EventHandler(this.ScoreHero_MenuItem_Click);
			this.GH3Folder_MenuItem.Name = "GH3Folder_MenuItem";
			this.GH3Folder_MenuItem.ShortcutKeys = Keys.F3;
			this.GH3Folder_MenuItem.Size = new Size(154, 22);
			this.GH3Folder_MenuItem.Text = "GH3 Folder";
			this.GH3Folder_MenuItem.Click += new EventHandler(this.GH3Folder_MenuItem_Click);
			this.toolStripSeparator3.Name = "toolStripSeparator3";
			this.toolStripSeparator3.Size = new Size(151, 6);
			this.Disclaimer_MenuItem.Name = "Disclaimer_MenuItem";
			this.Disclaimer_MenuItem.ShortcutKeys = Keys.F11;
			this.Disclaimer_MenuItem.Size = new Size(154, 22);
			this.Disclaimer_MenuItem.Text = "Disclaimer";
			this.Disclaimer_MenuItem.Click += new EventHandler(this.Disclaimer_MenuItem_Click);
			this.About_MenuItem.Name = "About_MenuItem";
			this.About_MenuItem.ShortcutKeys = Keys.F12;
			this.About_MenuItem.Size = new Size(154, 22);
			this.About_MenuItem.Text = "About";
			this.About_MenuItem.Click += new EventHandler(this.About_MenuItem_Click);
			this.ActionRequests_ListBox.Anchor = (AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right);
			this.ActionRequests_ListBox.FormattingEnabled = true;
			this.ActionRequests_ListBox.IntegralHeight = false;
			this.ActionRequests_ListBox.Location = new Point(0, 399);
			this.ActionRequests_ListBox.Margin = new Padding(0);
			this.ActionRequests_ListBox.Name = "ActionRequests_ListBox";
			this.ActionRequests_ListBox.ScrollAlwaysVisible = true;
			this.ActionRequests_ListBox.Size = new Size(180, 119);
			...
			this.label1.Size = new Size(174, 20);
			...
			this.label3.Location = new Point(3, 374);
			...
			this.SidePanel.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 100f));
			...
			this.SidePanel.Margin = new Padding(0);
			this.SidePanel.MinimumSize = new Size(180, 500);
			this.SidePanel.Name = "SidePanel";
			this.SidePanel.RowCount = 4;
			this.SidePanel.RowStyles.Add(new RowStyle(SizeType.Absolute, 20f));
			this.SidePanel.RowStyles.Add(new RowStyle(SizeType.Percent, 75f));
			this.SidePanel.RowStyles.Add(new RowStyle(SizeType.Absolute, 25f));
			this.SidePanel.RowStyles.Add(new RowStyle(SizeType.Percent, 25f));
			this.SidePanel.Size = new Size(180, 518);
			this.SidePanel.TabIndex = 7;
			this.notifyIcon_0.Icon = (Icon)componentResourceManager.GetObject("sysTrayIcon.Icon");
			this.notifyIcon_0.Text = "Guitar Hero Three Control Panel";
			this.notifyIcon_0.Visible = true;
			this.notifyIcon_0.MouseDown += new MouseEventHandler(this.notifyIcon_0_MouseDown);
			this.fontDialog_0.Color = Color.Red;
			this.fontDialog_0.Font = new Font("Microsoft Sans Serif", 12f, FontStyle.Bold, GraphicsUnit.Point, 0);
			this.fontDialog_0.ShowColor = true;
			this.leftClickMenu.Items.AddRange(new ToolStripItem[]
			{
			...
			this.SongEditor_Container.ContentPanel.Size = new Size(590, 436);
			this.SongEditor_Container.Dock = DockStyle.Fill;
			this.SongEditor_Container.Location = new Point(3, 3);
			this.SongEditor_Container.Name = "SongEditor_Container";
			this.SongEditor_Container.Size = new Size(590, 486);
			...
			this.SongEditor_BottomToolStrip.Dock = DockStyle.None;
			this.SongEditor_BottomToolStrip.GripStyle = ToolStripGripStyle.Hidden;
			this.SongEditor_BottomToolStrip.Items.AddRange(new ToolStripItem[]
			{
			...
			this.SongEditor_BottomToolStrip.Location = new Point(0, 0);
			this.SongEditor_BottomToolStrip.Name = "SongEditor_BottomToolStrip";
			this.SongEditor_BottomToolStrip.Size = new Size(590, 25);
			this.SongEditor_BottomToolStrip.Stretch = true;
			this.SongEditor_BottomToolStrip.TabIndex = 0;
			this.ToggleElements_EditorSplitBtn.DisplayStyle = ToolStripItemDisplayStyle.Text;
			this.ToggleElements_EditorSplitBtn.DropDownItems.AddRange(new ToolStripItem[]
			{
				this.StarView_EditorBtn,
				this.HopoView_EditorBtn,
				this.AudioView_EditorBtn
			});
			this.ToggleElements_EditorSplitBtn.Image = (Image)componentResourceManager.GetObject("ToggleElements_EditorSplitBtn.Image");
			this.ToggleElements_EditorSplitBtn.ImageTransparentColor = Color.Magenta;
			this.ToggleElements_EditorSplitBtn.Name = "ToggleElements_EditorSplitBtn";
			this.ToggleElements_EditorSplitBtn.Size = new Size(111, 22);
			this.ToggleElements_EditorSplitBtn.Text = "Toggle Elements";
			this.ToggleElements_EditorSplitBtn.ButtonClick += new EventHandler(this.ToggleElements_EditorSplitBtn_ButtonClick);
			this.StarView_EditorBtn.Checked = true;
			this.StarView_EditorBtn.CheckOnClick = true;
			this.StarView_EditorBtn.CheckState = CheckState.Checked;
			this.StarView_EditorBtn.Name = "StarView_EditorBtn";
			this.StarView_EditorBtn.Size = new Size(130, 22);
			this.StarView_EditorBtn.Text = "Star Power";
			this.StarView_EditorBtn.Click += new EventHandler(this.StarView_EditorBtn_Click);
			this.HopoView_EditorBtn.Checked = true;
			this.HopoView_EditorBtn.CheckOnClick = true;
			this.HopoView_EditorBtn.CheckState = CheckState.Checked;
			this.HopoView_EditorBtn.Name = "HopoView_EditorBtn";
			this.HopoView_EditorBtn.Size = new Size(130, 22);
			this.HopoView_EditorBtn.Text = "HoPo";
			this.HopoView_EditorBtn.Click += new EventHandler(this.HopoView_EditorBtn_Click);
			this.AudioView_EditorBtn.Checked = true;
			this.AudioView_EditorBtn.CheckOnClick = true;
			this.AudioView_EditorBtn.CheckState = CheckState.Checked;
			this.AudioView_EditorBtn.Name = "AudioView_EditorBtn";
			this.AudioView_EditorBtn.Size = new Size(130, 22);
			this.AudioView_EditorBtn.Text = "Audio";
			this.AudioView_EditorBtn.Click += new EventHandler(this.AudioView_EditorBtn_Click);
			this.toolStripSeparator10.Name = "toolStripSeparator10";
			this.toolStripSeparator10.Size = new Size(6, 25);
			this.toolStripLabel1.Font = new Font("Times New Roman", 12f, FontStyle.Bold);
			this.toolStripLabel1.Name = "toolStripLabel1";
			this.toolStripLabel1.Size = new Size(77, 22);
			this.toolStripLabel1.Text = "Beat Size:";
			this.BeatSize_EditorTxtBox.Name = "BeatSize_EditorTxtBox";
			this.BeatSize_EditorTxtBox.Size = new Size(30, 25);
			this.BeatSize_EditorTxtBox.Text = "20";
			this.BeatSize_EditorTxtBox.TextChanged += new EventHandler(this.BeatSize_EditorTxtBox_TextChanged);
			this.HyperSpeed_EditorBar.method_3(20);
			this.HyperSpeed_EditorBar.method_2(-20);
			this.HyperSpeed_EditorBar.Name = "HyperSpeed_EditorBar";
			this.HyperSpeed_EditorBar.Size = new Size(104, 22);
			this.HyperSpeed_EditorBar.ToolTipText = "HyperSpeed";
			this.HyperSpeed_EditorBar.method_7(new EventHandler(this.method_3));
			this.FretAngle_EditorBar.method_3(56);
			this.FretAngle_EditorBar.method_2(1);
			this.FretAngle_EditorBar.Name = "FretAngle_EditorBar";
			this.FretAngle_EditorBar.Size = new Size(104, 22);
			this.FretAngle_EditorBar.ToolTipText = "FretBar Angle";
			this.FretAngle_EditorBar.method_5(15);
			this.FretAngle_EditorBar.method_7(new EventHandler(this.method_2));
			this.toolStripSeparator12.Name = "toolStripSeparator12";
			this.toolStripSeparator12.Size = new Size(6, 25);
			this.toolStripLabel2.Font = new Font("Times New Roman", 12f, FontStyle.Bold);
			this.toolStripLabel2.Name = "toolStripLabel2";
			this.toolStripLabel2.Size = new Size(56, 22);
			this.toolStripLabel2.Text = "Offset:";
			this.Offset_EditorTxtBox.Name = "Offset_EditorTxtBox";
			this.Offset_EditorTxtBox.Size = new Size(50, 25);
			this.Offset_EditorTxtBox.Text = "20";
			this.Offset_EditorTxtBox.TextChanged += new EventHandler(this.Offset_EditorTxtBox_TextChanged);
			this.SongEditor_Control.BackColor = Color.White;
			this.SongEditor_Control.method_6(false);
			this.SongEditor_Control.method_10(0.0);
			this.SongEditor_Control.Dock = DockStyle.Fill;
			this.SongEditor_Control.method_8(true);
			this.SongEditor_Control.method_9(1.0);
			this.SongEditor_Control.Location = new Point(0, 0);
			this.SongEditor_Control.Name = "SongEditor_Control";
			this.SongEditor_Control.method_4(false);
			this.SongEditor_Control.Size = new Size(590, 436);
			this.SongEditor_Control.TabIndex = 0;
			this.SongEditor_Control.method_29(new SongEditor.Delegate10(this.method_1));
			this.SongEditor_TopToolStrip.Dock = DockStyle.None;
			this.SongEditor_TopToolStrip.GripStyle = ToolStripGripStyle.Hidden;
			this.SongEditor_TopToolStrip.Items.AddRange(new ToolStripItem[]
			{
			...
			this.SongEditor_TopToolStrip.Location = new Point(0, 0);
			this.SongEditor_TopToolStrip.Name = "SongEditor_TopToolStrip";
			this.SongEditor_TopToolStrip.Size = new Size(590, 25);
			...
			this.GameMode_EditorBtn.CheckState = CheckState.Checked;
			this.GameMode_EditorBtn.DisplayStyle = ToolStripItemDisplayStyle.Text;
			this.GameMode_EditorBtn.Image = (Image)componentResourceManager.GetObject("GameMode_EditorBtn.Image");
			this.GameMode_EditorBtn.ImageTransparentColor = Color.Magenta;
			this.GameMode_EditorBtn.Name = "GameMode_EditorBtn";
			this.GameMode_EditorBtn.Size = new Size(76, 24);
			this.GameMode_EditorBtn.Text = "Game Mode";
			this.GameMode_EditorBtn.Click += new EventHandler(this.GameMode_EditorBtn_Click);
			this.toolStripSeparator5.Name = "toolStripSeparator5";
			this.toolStripSeparator5.Size = new Size(6, 27);
			this.LoadChart_EditorBtn.DisplayStyle = ToolStripItemDisplayStyle.Text;
			this.LoadChart_EditorBtn.Image = (Image)componentResourceManager.GetObject("LoadChart_EditorBtn.Image");
			this.LoadChart_EditorBtn.ImageTransparentColor = Color.Magenta;
			this.LoadChart_EditorBtn.Name = "LoadChart_EditorBtn";
			this.LoadChart_EditorBtn.Size = new Size(69, 24);
			this.LoadChart_EditorBtn.Text = "Load Chart";
			this.LoadChart_EditorBtn.Click += new EventHandler(this.LoadChart_EditorBtn_Click);
			this.SelectedTrack_EditorBox.DropDownStyle = ComboBoxStyle.DropDownList;
			this.SelectedTrack_EditorBox.Name = "SelectedTrack_EditorBox";
			this.SelectedTrack_EditorBox.Size = new Size(100, 27);
			this.SelectedTrack_EditorBox.SelectedIndexChanged += new EventHandler(this.SelectedTrack_EditorBox_SelectedIndexChanged);
			this.SongName_EditorLbl.Name = "SongName_EditorLbl";
			this.SongName_EditorLbl.Size = new Size(69, 24);
			this.SongName_EditorLbl.Text = "Song Name";
			this.toolStripSeparator2.Name = "toolStripSeparator2";
			this.toolStripSeparator2.Size = new Size(6, 27);
			this.LoadAudio_EditorBtn.DisplayStyle = ToolStripItemDisplayStyle.Text;
			this.LoadAudio_EditorBtn.Image = (Image)componentResourceManager.GetObject("LoadAudio_EditorBtn.Image");
			this.LoadAudio_EditorBtn.ImageTransparentColor = Color.Magenta;
			this.LoadAudio_EditorBtn.Name = "LoadAudio_EditorBtn";
			this.LoadAudio_EditorBtn.Size = new Size(72, 24);
			this.LoadAudio_EditorBtn.Text = "Load Audio";
			this.LoadAudio_EditorBtn.Click += new EventHandler(this.LoadAudio_EditorBtn_Click);
			this.PlayPause_EditorBtn.DisplayStyle = ToolStripItemDisplayStyle.Text;
			this.PlayPause_EditorBtn.Image = (Image)componentResourceManager.GetObject("PlayPause_EditorBtn.Image");
			this.PlayPause_EditorBtn.ImageTransparentColor = Color.Magenta;
			this.PlayPause_EditorBtn.Name = "PlayPause_EditorBtn";
			this.PlayPause_EditorBtn.Size = new Size(69, 24);
			this.PlayPause_EditorBtn.Text = "Play/Pause";
			this.PlayPause_EditorBtn.Click += new EventHandler(this.PlayPause_EditorBtn_Click);
			this.Stop_EditorBtn.DisplayStyle = ToolStripItemDisplayStyle.Text;
			this.Stop_EditorBtn.Image = (Image)componentResourceManager.GetObject("Stop_EditorBtn.Image");
			this.Stop_EditorBtn.ImageTransparentColor = Color.Magenta;
			this.Stop_EditorBtn.Name = "Stop_EditorBtn";
			this.Stop_EditorBtn.Size = new Size(35, 24);
			this.Stop_EditorBtn.Text = "Stop";
			this.Stop_EditorBtn.Click += new EventHandler(this.Stop_EditorBtn_Click);
			this.PlayTime_EditorLbl.Name = "PlayTime_EditorLbl";
			this.PlayTime_EditorLbl.Size = new Size(59, 24);
			this.PlayTime_EditorLbl.Text = "Play Time";
			this.SetlistTab.Controls.Add(this.SetlistConfig_Container);
			this.SetlistTab.Location = new Point(4, 22);
			this.SetlistTab.Name = "SetlistTab";
			this.SetlistTab.Padding = new Padding(3);
			this.SetlistTab.Size = new Size(596, 492);
			...
			this.SetlistConfig_Container.ContentPanel.Size = new Size(590, 461);
			this.SetlistConfig_Container.Dock = DockStyle.Fill;
			this.SetlistConfig_Container.Location = new Point(3, 3);
			this.SetlistConfig_Container.Name = "SetlistConfig_Container";
			this.SetlistConfig_Container.Size = new Size(590, 486);
			...
			this.SetlistConf_TLPanel.CellBorderStyle = TableLayoutPanelCellBorderStyle.Single;
			this.SetlistConf_TLPanel.ColumnCount = 1;
			this.SetlistConf_TLPanel.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 100f));
			...
			this.SetlistConf_TLPanel.Dock = DockStyle.Fill;
			this.SetlistConf_TLPanel.Location = new Point(0, 0);
			this.SetlistConf_TLPanel.Name = "SetlistConf_TLPanel";
			this.SetlistConf_TLPanel.RowCount = 2;
			this.SetlistConf_TLPanel.RowStyles.Add(new RowStyle());
			this.SetlistConf_TLPanel.RowStyles.Add(new RowStyle(SizeType.Percent, 100f));
			this.SetlistConf_TLPanel.Size = new Size(590, 461);
			this.SetlistConf_TLPanel.TabIndex = 2;
			this.Setlist_TLPanel.ColumnCount = 4;
			this.Setlist_TLPanel.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 25f));
			this.Setlist_TLPanel.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 25f));
			this.Setlist_TLPanel.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 25f));
			this.Setlist_TLPanel.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 25f));
			...
			this.Setlist_TLPanel.Dock = DockStyle.Fill;
			this.Setlist_TLPanel.Location = new Point(4, 4);
			this.Setlist_TLPanel.Name = "Setlist_TLPanel";
			this.Setlist_TLPanel.RowCount = 3;
			this.Setlist_TLPanel.RowStyles.Add(new RowStyle(SizeType.Absolute, 20f));
			this.Setlist_TLPanel.RowStyles.Add(new RowStyle(SizeType.Absolute, 26f));
			this.Setlist_TLPanel.RowStyles.Add(new RowStyle(SizeType.Absolute, 20f));
			this.Setlist_TLPanel.Size = new Size(582, 44);
			this.Setlist_TLPanel.TabIndex = 0;
			this.textBox3.Dock = DockStyle.Fill;
			this.textBox3.Location = new Point(148, 49);
			this.textBox3.Name = "textBox3";
			this.textBox3.Size = new Size(139, 20);
			...
			this.label5.Location = new Point(438, 0);
			this.label5.Name = "label5";
			this.label5.Size = new Size(141, 20);
			...
			this.label4.Location = new Point(293, 0);
			this.label4.Name = "label4";
			this.label4.Size = new Size(139, 20);
			this.label4.TabIndex = 4;
			this.label4.Text = "Initial Movie";
			this.label4.TextAlign = ContentAlignment.MiddleCenter;
			this.TierBox.Dock = DockStyle.Fill;
			this.TierBox.DropDownStyle = ComboBoxStyle.DropDownList;
			this.TierBox.FormattingEnabled = true;
			this.TierBox.Location = new Point(438, 23);
			this.TierBox.Name = "TierBox";
			this.TierBox.Size = new Size(141, 21);
			this.TierBox.TabIndex = 7;
			this.TierBox.SelectedIndexChanged += new EventHandler(this.TierBox_SelectedIndexChanged);
			this.SetlistInitMovie_TxtBox.Dock = DockStyle.Fill;
			this.SetlistInitMovie_TxtBox.Location = new Point(293, 23);
			this.SetlistInitMovie_TxtBox.Name = "SetlistInitMovie_TxtBox";
			this.SetlistInitMovie_TxtBox.Size = new Size(139, 20);
			this.SetlistInitMovie_TxtBox.TabIndex = 6;
			this.SetlistInitMovie_TxtBox.TextChanged += new EventHandler(this.SetlistTitle_TxtBox_TextChanged);
			this.SetlistPrefix_TxtBox.Dock = DockStyle.Fill;
			this.SetlistPrefix_TxtBox.Enabled = false;
			this.SetlistPrefix_TxtBox.Location = new Point(148, 23);
			this.SetlistPrefix_TxtBox.Name = "SetlistPrefix_TxtBox";
			this.SetlistPrefix_TxtBox.Size = new Size(139, 20);
			...
			this.label2.Size = new Size(139, 20);
			...
			this.label13.Location = new Point(148, 0);
			this.label13.Name = "label13";
			this.label13.Size = new Size(139, 20);
			this.label13.TabIndex = 8;
			this.label13.Text = "Prefix";
			this.label13.TextAlign = ContentAlignment.MiddleCenter;
			this.SetlistTitle_TxtBox.Dock = DockStyle.Fill;
			this.SetlistTitle_TxtBox.Enabled = false;
			this.SetlistTitle_TxtBox.Location = new Point(3, 23);
			this.SetlistTitle_TxtBox.Name = "SetlistTitle_TxtBox";
			this.SetlistTitle_TxtBox.Size = new Size(139, 20);
			this.SetlistTitle_TxtBox.TabIndex = 9;
			this.SetlistTitle_TxtBox.TextChanged += new EventHandler(this.SetlistTitle_TxtBox_TextChanged);
			this.Tier_TLPanel.ColumnCount = 2;
			this.Tier_TLPanel.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 100f));
			this.Tier_TLPanel.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute, 180f));
			this.Tier_TLPanel.Controls.Add(this.TierProps_Panel, 0, 0);
			this.Tier_TLPanel.Controls.Add(this.TierSongs_Panel, 1, 0);
			this.Tier_TLPanel.Dock = DockStyle.Fill;
			this.Tier_TLPanel.Location = new Point(4, 55);
			this.Tier_TLPanel.Name = "Tier_TLPanel";
			this.Tier_TLPanel.RowCount = 1;
			this.Tier_TLPanel.RowStyles.Add(new RowStyle(SizeType.Percent, 100f));
			this.Tier_TLPanel.Size = new Size(582, 402);
			...
			this.TierProps_Panel.Dock = DockStyle.Fill;
			this.TierProps_Panel.Location = new Point(3, 3);
			this.TierProps_Panel.Name = "TierProps_Panel";
			this.TierProps_Panel.Size = new Size(396, 396);
			this.TierProps_Panel.TabIndex = 0;
			this.TierUnlockedSet_Btn.Font = new Font("Times New Roman", 8.25f, FontStyle.Bold, GraphicsUnit.Point, 0);
			this.TierUnlockedSet_Btn.Location = new Point(242, 55);
			this.TierUnlockedSet_Btn.Name = "TierUnlockedSet_Btn";
			this.TierUnlockedSet_Btn.Size = new Size(33, 20);
			this.TierUnlockedSet_Btn.TabIndex = 23;
			this.TierUnlockedSet_Btn.Text = "=";
			this.TierUnlockedSet_Btn.UseVisualStyleBackColor = true;
			this.TierUnlockedSet_Btn.Click += new EventHandler(this.TierUnlockedSet_Btn_Click);
			this.UnlockAll_CheckBox.AutoSize = true;
			this.UnlockAll_CheckBox.Font = new Font("Times New Roman", 12f, FontStyle.Bold, GraphicsUnit.Point, 0);
			this.UnlockAll_CheckBox.Location = new Point(226, 168);
			this.UnlockAll_CheckBox.Name = "UnlockAll_CheckBox";
			this.UnlockAll_CheckBox.Size = new Size(97, 23);
			...
			this.UnlockAll_CheckBox.CheckedChanged += new EventHandler(this.TierEncorep1_CheckBox_CheckedChanged);
			this.NoCash_CheckBox.AutoSize = true;
			this.NoCash_CheckBox.Font = new Font("Times New Roman", 12f, FontStyle.Bold, GraphicsUnit.Point, 0);
			this.NoCash_CheckBox.Location = new Point(128, 168);
			this.NoCash_CheckBox.Name = "NoCash_CheckBox";
			this.NoCash_CheckBox.Size = new Size(86, 23);
			this.NoCash_CheckBox.TabIndex = 15;
			this.NoCash_CheckBox.Text = "No Cash";
			this.NoCash_CheckBox.UseVisualStyleBackColor = true;
			this.NoCash_CheckBox.CheckedChanged += new EventHandler(this.TierEncorep1_CheckBox_CheckedChanged);
			this.TierApply_Btn.Font = new Font("Times New Roman", 12f, FontStyle.Bold, GraphicsUnit.Point, 0);
			this.TierApply_Btn.Location = new Point(16, 255);
			this.TierApply_Btn.Name = "TierApply_Btn";
			this.TierApply_Btn.Size = new Size(153, 27);
			this.TierApply_Btn.TabIndex = 17;
			this.TierApply_Btn.Text = "Apply Tier Changes";
			this.TierApply_Btn.UseVisualStyleBackColor = true;
			this.TierApply_Btn.Click += new EventHandler(this.TierApply_Btn_Click);
			this.label12.AutoSize = true;
			this.label12.Font = new Font("Times New Roman", 12f, FontStyle.Bold, GraphicsUnit.Point, 0);
			this.label12.Location = new Point(89, 5);
			this.label12.Name = "label12";
			this.label12.Size = new Size(110, 19);
			this.label12.TabIndex = 21;
			this.label12.Text = "Tier Properties";
			this.label12.TextAlign = ContentAlignment.MiddleCenter;
			this.SetlistApply_Btn.Font = new Font("Times New Roman", 12f, FontStyle.Bold, GraphicsUnit.Point, 0);
			this.SetlistApply_Btn.Location = new Point(175, 255);
			this.SetlistApply_Btn.Name = "SetlistApply_Btn";
			this.SetlistApply_Btn.Size = new Size(169, 27);
			...
			this.SetlistApply_Btn.Click += new EventHandler(this.SetlistApply_Btn_Click);
			this.TierCompMovie_TxtBox.Location = new Point(156, 84);
			this.TierCompMovie_TxtBox.Name = "TierCompMovie_TxtBox";
			this.TierCompMovie_TxtBox.Size = new Size(119, 20);
			this.TierCompMovie_TxtBox.TabIndex = 10;
			this.TierCompMovie_TxtBox.TextChanged += new EventHandler(this.TierEncorep1_CheckBox_CheckedChanged);
			this.TierUnlocked_NumBox.Location = new Point(193, 55);
			NumericUpDown arg_40A0_0 = this.TierUnlocked_NumBox;
			int[] array = new int[4];
			array[0] = 500;
			arg_40A0_0.Maximum = new decimal(array);
			this.TierUnlocked_NumBox.Name = "TierUnlocked_NumBox";
			this.TierUnlocked_NumBox.Size = new Size(43, 20);
			this.TierUnlocked_NumBox.TabIndex = 9;
			this.TierUnlocked_NumBox.ValueChanged += new EventHandler(this.TierEncorep1_CheckBox_CheckedChanged);
			this.TierTitle_TxtBox.Location = new Point(63, 26);
			this.TierTitle_TxtBox.Name = "TierTitle_TxtBox";
			this.TierTitle_TxtBox.Size = new Size(212, 20);
			this.TierTitle_TxtBox.TabIndex = 8;
			this.TierTitle_TxtBox.TextChanged += new EventHandler(this.TierEncorep1_CheckBox_CheckedChanged);
			this.TierIcon_DropBox.DropDownStyle = ComboBoxStyle.DropDownList;
			this.TierIcon_DropBox.FormattingEnabled = true;
			this.TierIcon_DropBox.Items.AddRange(new object[]
			{
				"No Icon"
			});
			this.TierIcon_DropBox.Location = new Point(93, 112);
			this.TierIcon_DropBox.Name = "TierIcon_DropBox";
			this.TierIcon_DropBox.Size = new Size(182, 21);
			this.TierIcon_DropBox.TabIndex = 11;
			this.TierIcon_DropBox.SelectedIndexChanged += new EventHandler(this.TierEncorep1_CheckBox_CheckedChanged);
			this.TierStage_DropBox.DropDownStyle = ComboBoxStyle.DropDownList;
			this.TierStage_DropBox.FormattingEnabled = true;
			this.TierStage_DropBox.Items.AddRange(new object[]
			{
				"No Preset Stage"
			});
			this.TierStage_DropBox.Location = new Point(70, 141);
			this.TierStage_DropBox.Name = "TierStage_DropBox";
			this.TierStage_DropBox.Size = new Size(205, 21);
			this.TierStage_DropBox.TabIndex = 12;
			this.TierStage_DropBox.SelectedIndexChanged += new EventHandler(this.TierEncorep1_CheckBox_CheckedChanged);
			this.TierBoss_CheckBox.AutoSize = true;
			this.TierBoss_CheckBox.Font = new Font("Times New Roman", 12f, FontStyle.Bold, GraphicsUnit.Point, 0);
			this.TierBoss_CheckBox.Location = new Point(16, 168);
			this.TierBoss_CheckBox.Name = "TierBoss_CheckBox";
			this.TierBoss_CheckBox.Size = new Size(106, 23);
			...
			this.TierBoss_CheckBox.CheckedChanged += new EventHandler(this.TierEncorep1_CheckBox_CheckedChanged);
			this.TierEncorep2_CheckBox.AutoSize = true;
			this.TierEncorep2_CheckBox.Font = new Font("Times New Roman", 12f, FontStyle.Bold, GraphicsUnit.Point, 0);
			this.TierEncorep2_CheckBox.Location = new Point(128, 197);
			this.TierEncorep2_CheckBox.Name = "TierEncorep2_CheckBox";
			this.TierEncorep2_CheckBox.Size = new Size(96, 23);
			...
			this.TierEncorep2_CheckBox.CheckedChanged += new EventHandler(this.TierEncorep1_CheckBox_CheckedChanged);
			this.TierEncorep1_CheckBox.AutoSize = true;
			this.TierEncorep1_CheckBox.Font = new Font("Times New Roman", 12f, FontStyle.Bold, GraphicsUnit.Point, 0);
			this.TierEncorep1_CheckBox.Location = new Point(16, 197);
			this.TierEncorep1_CheckBox.Name = "TierEncorep1_CheckBox";
			this.TierEncorep1_CheckBox.Size = new Size(96, 23);
			...
			this.TierEncorep1_CheckBox.CheckedChanged += new EventHandler(this.TierEncorep1_CheckBox_CheckedChanged);
			...
			this.label10.Size = new Size(52, 19);
			...
			this.label9.Location = new Point(12, 111);
			...
			this.label8.Location = new Point(12, 83);
			this.label8.Name = "label8";
			this.label8.Size = new Size(138, 19);
			...
			this.label7.Location = new Point(12, 55);
			this.label7.Name = "label7";
			this.label7.Size = new Size(175, 19);
			this.label7.TabIndex = 6;
			this.label7.Text = "Default Unlocked Songs:";
			this.label7.TextAlign = ContentAlignment.MiddleCenter;
			this.TierSongs_Panel.ColumnCount = 1;
			this.TierSongs_Panel.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 100f));
			this.TierSongs_Panel.Controls.Add(this.TierSongs_ListBox, 0, 1);
			this.TierSongs_Panel.Controls.Add(this.label11, 0, 0);
			this.TierSongs_Panel.Dock = DockStyle.Fill;
			this.TierSongs_Panel.Location = new Point(405, 3);
			this.TierSongs_Panel.Name = "TierSongs_Panel";
			this.TierSongs_Panel.RowCount = 2;
			this.TierSongs_Panel.RowStyles.Add(new RowStyle(SizeType.Absolute, 20f));
			this.TierSongs_Panel.RowStyles.Add(new RowStyle(SizeType.Percent, 100f));
			this.TierSongs_Panel.Size = new Size(174, 396);
			this.TierSongs_Panel.TabIndex = 1;
			this.TierSongs_ListBox.AllowDrop = true;
			this.TierSongs_ListBox.Anchor = (AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right);
			...
			this.TierSongs_ListBox.Location = new Point(0, 20);
			this.TierSongs_ListBox.Margin = new Padding(0);
			this.TierSongs_ListBox.Name = "TierSongs_ListBox";
			this.TierSongs_ListBox.ScrollAlwaysVisible = true;
			this.TierSongs_ListBox.SelectionMode = SelectionMode.MultiExtended;
			this.TierSongs_ListBox.Size = new Size(174, 376);
			this.TierSongs_ListBox.TabIndex = 19;
			this.TierSongs_ListBox.method_6(new EventHandler<EventArgs2>(this.method_21));
			this.TierSongs_ListBox.KeyDown += new KeyEventHandler(this.TierSongs_ListBox_KeyDown);
			this.TierSongs_ListBox.MouseDown += new MouseEventHandler(this.TierSongs_ListBox_MouseDown);
			...
			this.label11.Size = new Size(168, 20);
			this.label11.TabIndex = 5;
			this.label11.Text = "Tier Songs";
			this.label11.TextAlign = ContentAlignment.MiddleCenter;
			this.SetlistStrip.Dock = DockStyle.None;
			this.SetlistStrip.GripStyle = ToolStripGripStyle.Hidden;
			this.SetlistStrip.Items.AddRange(new ToolStripItem[]
			{
				this.Setlist_Lbl,
			...
			this.SetlistStrip.Location = new Point(0, 0);
			this.SetlistStrip.Name = "SetlistStrip";
			this.SetlistStrip.Size = new Size(590, 25);
			this.SetlistStrip.Stretch = true;
			this.SetlistStrip.TabIndex = 0;
			this.SetlistStrip.Text = "toolStrip1";
			this.Setlist_Lbl.Font = new Font("Times New Roman", 12f, FontStyle.Bold);
			this.Setlist_Lbl.Name = "Setlist_Lbl";
			this.Setlist_Lbl.Size = new Size(56, 24);
			this.Setlist_Lbl.Text = "Setlist:";
			this.Setlist_DropBox.DropDownStyle = ComboBoxStyle.DropDownList;
			this.Setlist_DropBox.Name = "Setlist_DropBox";
			this.Setlist_DropBox.Size = new Size(121, 27);
			this.Setlist_DropBox.SelectedIndexChanged += new EventHandler(this.Setlist_DropBox_SelectedIndexChanged);
			this.CreateSetlist_Btn.DisplayStyle = ToolStripItemDisplayStyle.Text;
			this.CreateSetlist_Btn.Image = (Image)componentResourceManager.GetObject("CreateSetlist_Btn.Image");
			this.CreateSetlist_Btn.ImageTransparentColor = Color.Magenta;
			this.CreateSetlist_Btn.Name = "CreateSetlist_Btn";
			this.CreateSetlist_Btn.Size = new Size(79, 24);
			this.CreateSetlist_Btn.Text = "Create Setlist";
			this.CreateSetlist_Btn.Click += new EventHandler(this.CreateSetlist_Btn_Click);
			this.DeleteSetlist_Btn.DisplayStyle = ToolStripItemDisplayStyle.Text;
			this.DeleteSetlist_Btn.Image = (Image)componentResourceManager.GetObject("DeleteSetlist_Btn.Image");
			this.DeleteSetlist_Btn.ImageTransparentColor = Color.Magenta;
			this.DeleteSetlist_Btn.Name = "DeleteSetlist_Btn";
			this.DeleteSetlist_Btn.Size = new Size(78, 24);
			this.DeleteSetlist_Btn.Text = "Delete Setlist";
			this.DeleteSetlist_Btn.Click += new EventHandler(this.DeleteSetlist_Btn_Click);
			this.SettingsTab.Location = new Point(4, 22);
			this.SettingsTab.Margin = new Padding(0);
			this.SettingsTab.Name = "SettingsTab";
			this.SettingsTab.Size = new Size(596, 492);
			...
			this.TabControl.Location = new Point(180, 0);
			this.TabControl.Margin = new Padding(0);
			this.TabControl.MinimumSize = new Size(600, 500);
			this.TabControl.Name = "TabControl";
			this.TabControl.SelectedIndex = 0;
			this.TabControl.Size = new Size(604, 518);
			...
			this.MainContainer.ContentPanel.Size = new Size(784, 518);
			...
			this.MainContainer.Size = new Size(784, 564);
			...
			this.ToolStripStatusLbl.Size = new Size(0, 17);
			this.ToolStripStatusLbl.Tag = "Function Description";
			base.AutoScaleDimensions = new SizeF(6f, 13f);
			base.AutoScaleMode = AutoScaleMode.Font;
			base.ClientSize = new Size(784, 564);
			base.Controls.Add(this.MainContainer);
			this.DoubleBuffered = true;
			base.MainMenuStrip = this.TopMenuStrip;
			this.MinimumSize = new Size(800, 600);
			base.Name = "MainMenu";
			this.Text = "Guitar Hero Three Control Panel";
			base.FormClosing += new FormClosingEventHandler(this.MainMenu_FormClosing);
			base.SizeChanged += new EventHandler(this.MainMenu_SizeChanged);
			...
			((ISupportInitialize)this.TierUnlocked_NumBox).EndInit();
		...
		private void method_14(bool bool_1)
		{
			...
			{
				RegistryKey registryKey = Registry.LocalMachine.OpenSubKey(this.string_1);
				this.string_4 = (string)registryKey.GetValue("Path") + "\\DATA\\";
			...
			catch
			{
				...
				try
				{
					this.string_4 = new FileInfo(text).Directory.FullName;
					RegistryKey registryKey = Registry.LocalMachine.CreateSubKey(this.string_1);
					registryKey.SetValue("Path", this.string_4);
					this.string_4 += "\\DATA\\";
				}
				catch
				{
			...
			using (new Class217("QB Parse Operations"))
			{
				try
				{
					...
					using (this.class319_0 = new Class319(this.string_4 + "PAK\\qb" + text2 + ".pak.xen", this.string_4 + "PAK\\qb" + text2 + ".pab.xen", false))
					{
						...
						Class244.smethod_19(this.string_4 + "PAK\\qb" + text2 + ".pab.xen", string.Concat(new string[]
						{
							this.string_0,
							this.string_3,
							"lastedited\\qb",
						...
						Class244.smethod_19(this.string_4 + "PAK\\qb" + text2 + ".pak.xen", string.Concat(new string[]
						{
							this.string_0,
							this.string_3,
							"lastedited\\qb",
						...
						Class244.smethod_19(string.Concat(new string[]
						{
							...
							text2,
							".pab.xen"
						}), this.string_4 + "PAK\\qb" + text2 + ".pab.xen", true);
						Class244.smethod_19(string.Concat(new string[]
						{
							this.string_0,
							this.string_3,
							...
							text2,
							".pak.xen"
						}), this.string_4 + "PAK\\qb" + text2 + ".pak.xen", true);
						IL_478:;
					}
					this.class319_0 = new Class319(this.string_4 + "PAK\\qb" + text2 + ".pak.xen", this.string_4 + "PAK\\qb" + text2 + ".pab.xen", false);
					this.method_20(int_);
					...
					if (flag && gH3Songlist.dictionary_0.Count != 0)
					{
						bool flag2 = false;
						using (Dictionary<int, GH3Setlist>.KeyCollection.Enumerator enumerator2 = gH3Songlist.dictionary_0.Keys.GetEnumerator())
						{
							IL_78C:
							while (enumerator2.MoveNext())
							{
								int current2 = enumerator2.Current;
								GH3Setlist gH3Setlist = gH3Songlist.dictionary_0[current2];
								...
								{
									this.gh3Songlist_0.dictionary_0[current2].method_0().AddRange(gH3Setlist.method_0());
		...
		private void method_15()
		{
			...
			if (this.gh3Songlist_0 != null)
			{
				...
				this.gh3Songlist_0.dictionary_0.Clear();
			}
		...
		{
			string text = this.string_4 + "PAK\\qb" + this.list_0[int_3] + ".pab.xen";
			int[] icollection_ = this.bool_0 ? this.int_2[int_3] : this.int_1[int_3];
		...
		private void RestoreOriginal_MenuItem_Click(object sender, EventArgs e)
		{
			...
			if (this.method_16(int_))
			{
				...
				Class244.smethod_19(string.Concat(new string[]
				{
					...
					text,
					".pak.xen"
				}), this.string_4 + "PAK\\" + text + ".pak.xen", true);
				Class244.smethod_19(string.Concat(new string[]
				{
					this.string_0,
					this.string_3,
					...
					text,
					".pab.xen"
				}), this.string_4 + "PAK\\" + text + ".pab.xen", true);
				return;
			}
			this.method_17(int_);
		}
		...
		private void GameSettingsSwitch_MenuItem_Click(object sender, EventArgs e)
		{
			...
			}), false))
			{
				...
				@class.method_20(this.string_4 + "PAK\\" + text + ".pak.xen", this.string_4 + "PAK\\" + text + ".pab.xen");
			}
			GC.Collect();
		}
