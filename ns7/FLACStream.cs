...
// 			this.class144_0.vmethod_10(this.class144_0.vmethod_4());
		...
		private void method_8()
		{
			...
			{
				Console.WriteLine("CRC Error: " + Convert.ToString(num & 65535, 16) + " vs " + Convert.ToString(_class1510.vmethod_0() & 65535, 16));
				for (var i = 0; i < _class1510.Class1400.Int2; i++)
				{
		...
		private void method_9(int int12, int int13)
		{
			...
			{
			case 0:
				_class1510.Class1310[int12] = new Class132(_class1440, _class1510.Class1400, _class1360[int12], int13, num2);
				goto IL_1AB;
			case 2:
				_class1510.Class1310[int12] = new Class133(_class1440, _class1510.Class1400, _class1360[int12], int13, num2);
				goto IL_1AB;
			}
			if (num < 16)
			{
			...
			if (num <= 24)
			{
				_class1510.Class1310[int12] = new Class134(_class1440, _class1510.Class1400, _class1360[int12], int13, num2, num >> 1 & 7);
			}
			else
			{
				if (num < 64)
				...
				_class1510.Class1310[int12] = new Class135(_class1440, _class1510.Class1400, _class1360[int12], int13, num2, (num >> 1 & 31) + 1);
			}
			IL_1AB:
			if (flag)
			{
		...
		public bool method_11(long long5)
		{
			...
			if (_class1270 != null)
			{
				...
				var num18 = num17 - 1;
				while (num18 >= 0 && (_class1270.Class1420[num18].Long0 <= -1L || _class1270.Class1420[num18].Int0 <= 0 || (num > 0L && _class1270.Class1420[num18].Long0 >= num) || _class1270.Class1420[num18].Long0 > long5))
				{
					num18--;
				}
				if (num18 >= 0)
				...
				num18 = 0;
				while (num18 < num17 && (_class1270.Class1420[num18].Long0 <= -1L || _class1270.Class1420[num18].Int0 <= 0 || (num > 0L && _class1270.Class1420[num18].Long0 >= num) || _class1270.Class1420[num18].Long0 <= long5))
				{
					num18++;
				}
				if (num18 < num17)
			...
			while (num10 < num12 && num9 <= num11)
			{
				...
				if (num19 < num9)
				{
					...
					for (var i = 0; i < 10; i++)
					{
						...
						if (_class1510.Class1400.Long0 <= long5 && _class1510.Class1400.Long0 + _class1510.Class1400.Int0 > long5)
						{
