...
namespace ns7
{
	public class Stream12 : Stream1
	{
		...
		public Stream12(string string_0) : this(File.OpenRead(string_0))
		{
		}

		public Stream12(Stream stream_1)
		{
			...
			this.long_4 = this.stream_0.Length;
		...
		private void method_2()
		{
			...
			while (i < 4)
			{
				...
				{
					if (num2 != (int)Stream12.byte_0[num])
					{
...
// 			this.class144_0.vmethod_10(this.class144_0.vmethod_4());
		...
		public bool method_11(long long_5)
		{
			if (long_5 == 0L)
			{
				this.stream_0.Position = this.long_3;
				this.class144_0.vmethod_2();
				this.int_10 = 0;
				this.long_0 = 0L;
				this.long_1 = 0L;
