	...
	public class ZzCollection1<T> : IEnumerable, ICollection<T>, IEnumerable<T>
	{
		...
		private bool method_6(int int6, int int7, T gparam1)
		{
			...
			for (var num = _int0[int6] - 1; num != -1; num = @struct.Int1)
			{
				...
				if (@struct.Int0 == int7 && ((int7 != -2147483648 || (gparam1 != null && _gparam0[num] != null)) ? _iequalityComparer0.Equals(gparam1, _gparam0[num]) : (gparam1 == null && null == _gparam0[num])))
				{
					return true;
				}
			}
		...
		public bool Remove(T item)
		{
			...
			do
			{
				...
				if (@struct.Int0 == num)
				{
					if ((num != -2147483648 || (item != null && _gparam0[num3] != null)) ? _iequalityComparer0.Equals(_gparam0[num3], item) : (item == null && null == _gparam0[num3]))
					{
						break;
					}
				}
