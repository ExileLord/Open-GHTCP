...
namespace GHNamespace9
{
    public class KeyGenerator
    {
        ...
        {
            if (File.Exists(fileName) && (File.GetAttributes(fileName) & FileAttributes.ReadOnly) ==
        ...
        public static void smethod_19(string string0, string string1, bool bool2)
        {
            ...
            if (bool2 && File.Exists(string1) && (File.GetAttributes(string1) & FileAttributes.ReadOnly) ==
                FileAttributes.ReadOnly)
            {
        ...
        public static int smethod_24(byte[] byte1, bool bool2)
        {
            ...
            switch (num)
            {
                ...
                default:
                    if (num == 8
                    ) //i am pretty sure this should just be another switch case but I'm not going to touch it for now
                    {
        ...
        {
            if (File.Exists(string0) && (File.GetAttributes(string0) & FileAttributes.ReadOnly) ==
                FileAttributes.ReadOnly)
            {
                File.SetAttributes(string0, FileAttributes.Normal);
            }
        ...
        public static bool smethod_54<T>(ICollection<T> icollection0, ICollection<T> icollection1, int int0)
            where T : IComparable
        {
            return smethod_55(icollection0, icollection1, int0, false);
        }

        public static bool smethod_55<T>(ICollection<T> icollection0, ICollection<T> icollection1, int int0, bool bool2)
            where T : IComparable
        {
