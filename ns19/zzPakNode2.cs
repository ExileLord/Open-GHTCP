...
namespace ns19
{
	public class ZzPakNode2 : ZzPakNode1, IEnumerable, IDisposable, IEnumerable<INterface12>
	{
		...
		private void method_4()
		{
			...
			Stream260.ReverseEndianness = (Bool2 = (!QbSongClass1.ContainsKey(num2) || !QbSongClass1.GetDictString(num2).StartsWith(".")));
			var @enum = (Enum35)Stream260.ReadIntAt(28);
			Bool1 = ((@enum & Enum35.Flag3) == Enum35.Flag0);
			Int0 = Stream260.ReadIntAt(Bool1 ? 12 : 16, Bool2 && (@enum & Enum35.Flag4) == Enum35.Flag0 && (@enum & Enum35.Flag5) == Enum35.Flag0);
		...
		public void method_18(Stream26 stream261, Stream26 stream262)
		{
			...
			foreach (var current in List0)
			{
				num += (((current.imethod_14() & Enum35.Flag3) == Enum35.Flag0 || !QbSongClass1.ContainsKey(current.imethod_7())) ? 32 : 192);
			}
			if (Bool1)
			{
			...
			foreach (var current2 in List0)
			{
				if (current2 is Class309 && (current2 as Class309).vmethod_8())
				{
					...
					else
					{
						...
						if (@interface.imethod_18() || ((Class328)@interface).Dictionary0 != (current2 as Class309).vmethod_10())
						{
			...
			{
				var flag = Bool2 && (current3.imethod_14() & Enum35.Flag4) == Enum35.Flag0 && (current3.imethod_14() & Enum35.Flag5) == Enum35.Flag0;
