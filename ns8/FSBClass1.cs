...
namespace ns8
{
	public class FSBClass1 : IDisposable
	{
		...
		private Enum23 method_0(int int_0)
		{
			if (enum20_0 == FSBEnum1.const_0)
			{
				return Enum23.const_0;
			}
			if (enum20_0 == FSBEnum1.const_1)
			{
				return Enum23.const_1;
			}
			if ((enum21_0 & FSBFlags1.flag_2) != FSBFlags1.flag_0 && int_0 != 0)
			{
				return Enum23.const_3;
			}
			if (enum20_0 == FSBEnum1.const_2)
			{
				return Enum23.const_1;
			}
			if (enum20_0 != FSBEnum1.const_3)
			{
				if (enum20_0 != FSBEnum1.const_4)
				{
					throw new Exception5("Unknown version \"" + enum20_0 + "\"");
				}
			}
		...
		private void method_5(BinaryReader inputBin, out int numSubFiles, out uint subFileHdrsSize, out uint allDataSize)
		{
			...
			enum20_0 = method_15(inputBin.ReadUInt32());
			enum21_0 = (FSBFlags1)inputBin.ReadUInt32();
		}
		...
		private void method_7(BinaryReader binaryReader_0, int int_0, long long_0)
		{
			...
			for (int i = 0; i < int_0; i++)
			{
				...
				{
				case Enum23.const_0:
					@class = method_8(binaryReader_0, out num2);
					break;
				case Enum23.const_1:
					@class = method_9(binaryReader_0, out num2);
					break;
				case Enum23.const_2:
					@class = method_12(binaryReader_0, out num2);
					break;
				case Enum23.const_3:
					@class = smethod_2(binaryReader_0, out num2, method_33()[0]);
					break;
				}
				method_33().Add(@class);
				@class.stream_1 = new Stream18(binaryReader_0.BaseStream, num, num2);
				num += num2;
			}
		}
		...
		private Class168 method_8(BinaryReader inputBin, out uint dataSize)
		{
			...
			@class.uint_3 = inputBin.ReadUInt16();
		...
		{
			class168_0.stream_0 = new Stream18(binaryReader_0.BaseStream, binaryReader_0.BaseStream.Position, uint_0);
		}
		...
		private void method_18(BinaryWriter binaryWriter_0)
		{
			...
			case FSBEnum1.const_0:
				binaryWriter_0.Write(smethod_8("FSB1", 4));
				method_19(binaryWriter_0);
				return;
			case FSBEnum1.const_1:
				binaryWriter_0.Write(smethod_8("FSB2", 4));
				method_20(binaryWriter_0);
				return;
			case FSBEnum1.const_2:
			case FSBEnum1.const_3:
				binaryWriter_0.Write(smethod_8("FSB3", 4));
				method_21(binaryWriter_0);
				return;
			case FSBEnum1.const_4:
				binaryWriter_0.Write(smethod_8("FSB4", 4));
				method_22(binaryWriter_0);
				return;
			default:
				return;
			}
		...
		{
			binaryWriter_0.Write(method_33().Count);
			binaryWriter_0.Write(method_31());
		...
		{
			binaryWriter_0.Write(method_33().Count);
			binaryWriter_0.Write(method_30());
			binaryWriter_0.Write(method_31());
		}
		...
		{
			method_20(binaryWriter_0);
			binaryWriter_0.Write(smethod_9(enum20_0));
			binaryWriter_0.Write((uint)enum21_0);
		}
		...
		private void method_24(BinaryWriter binaryWriter_0)
		{
			for (int i = 0; i < method_33().Count; i++)
			{
				...
				{
				case Enum23.const_0:
					method_25(binaryWriter_0, method_33()[i]);
					break;
				case Enum23.const_1:
					method_26(binaryWriter_0, method_33()[i]);
					break;
				case Enum23.const_2:
					method_28(binaryWriter_0, method_33()[i]);
					break;
				case Enum23.const_3:
					smethod_3(binaryWriter_0, method_33()[i]);
					break;
				}
			}
		...
		{
			binaryWriter_0.Write(smethod_8(class168_0.FileName, 32));
		...
		{
			method_27(binaryWriter_0, class168_0, smethod_5(class168_0));
		...
		private void method_27(BinaryWriter binaryWriter_0, Class168 class168_0, int int_0)
		{
			...
			binaryWriter_0.Write(smethod_8(class168_0.FileName, 30));
			binaryWriter_0.Write(class168_0.uint_0);
			binaryWriter_0.Write((uint)class168_0.stream_1.Length);
			binaryWriter_0.Write(class168_0.uint_1);
			binaryWriter_0.Write(class168_0.uint_2);
		...
		{
			method_29(binaryWriter_0, class168_0, smethod_6(class168_0));
			StreamHelper.CopyStream(binaryWriter_0.BaseStream, class168_0.stream_0);
		}

		private void method_29(BinaryWriter binaryWriter_0, Class168 class168_0, int int_0)
		{
			method_27(binaryWriter_0, class168_0, int_0);
