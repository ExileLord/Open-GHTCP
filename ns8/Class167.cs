...
namespace ns8
{
	public class Class167 : IDisposable
	{
		private enum Enum23
		{
			const_0,
		...
		private Class167.Enum23 method_0(int int_0)
		{
			if (this.enum20_0 == Enum20.const_0)
			{
				return Class167.Enum23.const_0;
			}
			if (this.enum20_0 == Enum20.const_1)
			{
				return Class167.Enum23.const_1;
			}
			if ((this.enum21_0 & Enum21.flag_2) != Enum21.flag_0 && int_0 != 0)
			{
				return Class167.Enum23.const_3;
			}
			...
			return Class167.Enum23.const_2;
		}

		public static Class167 smethod_0(Stream stream_1)
		{
			...
			catch
			{
				...
				Stream17 stream = new Stream17(stream_1);
				@class = new Class167();
		...
		public static Class167 smethod_1(Stream stream_1, byte[] byte_1)
		{
			Class167 @class = new Class167();
			@class.method_1(new Stream17(stream_1, byte_1));
			@class.byte_0 = byte_1;
			@class.stream_0 = stream_1;
			return @class;
		}
		...
		private void method_7(BinaryReader binaryReader_0, int int_0, long long_0)
		{
			...
			for (int i = 0; i < int_0; i++)
			{
				...
				{
				case Class167.Enum23.const_0:
					@class = this.method_8(binaryReader_0, out num2);
					break;
				case Class167.Enum23.const_1:
					@class = this.method_9(binaryReader_0, out num2);
					break;
				case Class167.Enum23.const_2:
					@class = this.method_12(binaryReader_0, out num2);
					break;
				case Class167.Enum23.const_3:
					@class = Class167.smethod_2(binaryReader_0, out num2, this.method_33()[0]);
					break;
				}
		...
		public void method_17(Stream stream_1)
		{
			if (this.byte_0 != null)
			{
				stream_1 = new Stream17(stream_1, this.byte_0);
			}
		...
		private void method_18(BinaryWriter binaryWriter_0)
		{
			...
			{
			case Enum20.const_0:
				binaryWriter_0.Write(Class167.smethod_8("FSB1", 4));
				this.method_19(binaryWriter_0);
				return;
			case Enum20.const_1:
				binaryWriter_0.Write(Class167.smethod_8("FSB2", 4));
				this.method_20(binaryWriter_0);
				return;
			case Enum20.const_2:
			case Enum20.const_3:
				binaryWriter_0.Write(Class167.smethod_8("FSB3", 4));
				this.method_21(binaryWriter_0);
				return;
			case Enum20.const_4:
				binaryWriter_0.Write(Class167.smethod_8("FSB4", 4));
		...
		{
			this.method_20(binaryWriter_0);
			binaryWriter_0.Write(Class167.smethod_9(this.enum20_0));
		...
		private void method_24(BinaryWriter binaryWriter_0)
		{
			for (int i = 0; i < this.method_33().Count; i++)
			{
				...
				case Class167.Enum23.const_2:
					...
					break;
				case Class167.Enum23.const_3:
					Class167.smethod_3(binaryWriter_0, this.method_33()[i]);
					break;
				}
			}
		...
		{
			binaryWriter_0.Write(Class167.smethod_8(class168_0.string_0, 32));
		...
		{
			this.method_27(binaryWriter_0, class168_0, Class167.smethod_5(class168_0));
		...
		private void method_27(BinaryWriter binaryWriter_0, Class168 class168_0, int int_0)
		{
			...
			binaryWriter_0.Write(Class167.smethod_8(class168_0.string_0, 30));
			binaryWriter_0.Write(class168_0.uint_0);
			binaryWriter_0.Write((uint)class168_0.stream_1.Length);
			binaryWriter_0.Write(class168_0.uint_1);
			binaryWriter_0.Write(class168_0.uint_2);
		...
		{
			this.method_29(binaryWriter_0, class168_0, Class167.smethod_6(class168_0));
			Class166.smethod_0(binaryWriter_0.BaseStream, class168_0.stream_0);
		}
		...
		private int method_30()
		{
			...
			for (int i = 0; i < this.method_33().Count; i++)
			{
				...
				{
				case Class167.Enum23.const_0:
					num += Class167.smethod_4(this.method_33()[i]);
					break;
				case Class167.Enum23.const_1:
					num += Class167.smethod_5(this.method_33()[i]);
					break;
				case Class167.Enum23.const_2:
					num += Class167.smethod_6(this.method_33()[i]);
					break;
				case Class167.Enum23.const_3:
					num += Class167.smethod_7(this.method_33()[i]);
					break;
				}
			}
			num = (num + 15 & -16);
