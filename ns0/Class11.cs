...
namespace ns0
{
	public static class Class11
	{
		...
		{
			var num = Math.Round(double_0 * 127.0) + 128.0;
			if (num > 255.0)
			{
				return 255;
			}
		...
		{
			var num = Math.Round(double_0 * 127.0);
			if (num > 127.0)
			{
				return 127;
			}
		...
		{
			var num = Math.Round(double_0 * 32767.0);
			if (num > 32767.0)
			{
				return 32767;
			}
		...
		{
			var num = Math.Round(double_0 * 8388607.0);
		...
		{
			var num = Math.Round(double_0 * 2147483647.0);
			if (num > 2147483647.0)
			{
				return 2147483647;
			}
