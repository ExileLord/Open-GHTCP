...
namespace ns10
{
	public class Class65
	{
		...
		public int method_0(Class38 class38_0)
		{
			if (class38_0.method_6(24) != 5653314)
			{
				this.method_2();
				return -1;
			}
			this.int_0 = class38_0.method_6(16);
			this.int_1 = class38_0.method_6(24);
			if (this.int_1 == -1)
			{
				this.method_2();
				return -1;
			}
			switch (class38_0.method_6(1))
			{
			case 0:
			...
			case 1:
			{
				int num3 = class38_0.method_6(5) + 1;
				this.int_2 = new int[this.int_1];
				int i = 0;
				while (i < this.int_1)
				{
					int num4 = class38_0.method_6(Class65.smethod_0(this.int_1 - i));
					if (num4 == -1)
					{
						this.method_2();
						return -1;
			...
			switch (this.int_3 = class38_0.method_6(4))
			{
			case 0:
				break;
			case 1:
			case 2:
			{
				this.int_4 = class38_0.method_6(32);
				this.int_5 = class38_0.method_6(32);
				this.int_6 = class38_0.method_6(4) + 1;
				this.int_7 = class38_0.method_6(1);
				int num5 = 0;
				switch (this.int_3)
				{
				case 1:
				...
				{
					this.int_8[i] = class38_0.method_6(this.int_6);
				}
		...
		public float[] method_3()
		{
			...
			float num = Class65.smethod_1(this.int_4);
			float num2 = Class65.smethod_1(this.int_5);
		...
		public static float smethod_1(int int_11)
		{
			...
			float num2 = (uint)(int_11 & 2145386496) >> Class65.int_9;
			if (((long)int_11 & 2147483648L) != 0L)
			{
				num = -num;
			}
			return Class65.smethod_2(num, (int)num2 - (Class65.int_9 - 1) - Class65.int_10);
		}
