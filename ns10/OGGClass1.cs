	...
	public class OGGClass1
	{
		...
		public static float[] smethod_1(int int_12, int int_13, int int_14, int int_15)
		{
			...
			if (int_12 == 0)
			{
				...
				{
					float num3 = (float)(((double)i + 0.5) / (double)int_14 * (double)OGGClass1.float_0 / 2.0);
					num3 = (float)Math.Sin((double)num3);
					num3 *= num3;
					num3 *= (float)((double)OGGClass1.float_0 / 2.0);
					num3 = (float)Math.Sin((double)num3);
					array[i + num] = num3;
				}
				...
				{
					float num4 = (float)(((double)(int_15 - k) - 0.5) / (double)int_15 * (double)OGGClass1.float_0 / 2.0);
					num4 = (float)Math.Sin((double)num4);
					num4 *= num4;
					num4 *= (float)((double)OGGClass1.float_0 / 2.0);
					num4 = (float)Math.Sin((double)num4);
					array[k + num2] = num4;
				}
				return array;
