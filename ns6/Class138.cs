...
namespace ns6
{
	public class Class138 : Class137
	{
		...
		public virtual void vmethod_0(Class144 class144_0, int int_1, int int_2, Class140 class140_0, int[] int_3)
		{
			var num = 0;
			var num2 = 1 << int_2;
			var num3 = (int_2 > 0) ? (class140_0.int_0 >> int_2) : (class140_0.int_0 - int_1);
			class143_0.vmethod_0(Math.Max(6, int_2));
			class143_0.int_0 = new int[num2];
			for (var i = 0; i < num2; i++)
			{
				var num4 = class144_0.vmethod_10(4);
				class143_0.int_0[i] = num4;
				if (num4 < 15)
				{
					var num5 = (int_2 == 0 || i > 0) ? num3 : (num3 - int_1);
