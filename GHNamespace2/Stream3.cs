...
namespace GHNamespace2
{
    public class Stream3 : GenericAudioStream
    {
        ...
        public Stream3(GenericAudioStream stream11, TimeSpan timeSpan0, TimeSpan timeSpan1) : this(stream11,
            Convert.ToInt32(stream11.vmethod_0().int_0 * stream11.vmethod_0().short_1 * timeSpan0.TotalSeconds),
            Convert.ToInt32(stream11.vmethod_0().int_0 * stream11.vmethod_0().short_1 * timeSpan1.TotalSeconds))
        {
        }
