...
namespace GHNamespaceH
{
    public class Class48
    {
        ...
        public int method_5()
        {
            return Byte0[Int0 + 14] & 255 | (Byte0[Int0 + 15] & 255) << 8 | (Byte0[Int0 + 16] & 255) << 16 |
                   (Byte0[Int0 + 17] & 255) << 24;
        }

        public int method_6()
        {
            return Byte0[Int0 + 18] & 255 | (Byte0[Int0 + 19] & 255) << 8 | (Byte0[Int0 + 20] & 255) << 16 |
                   (Byte0[Int0 + 21] & 255) << 24;
        }
