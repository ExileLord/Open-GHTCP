...
namespace GHNamespaceH
{
    public class Class35 : Class34
    {
        ...
        public override object vmethod_1(OggClass1 class660, Class27 class270, object object2)
        {
            ...
            Class54 class2 = @class.Class540 = (Class54) object2;
            ...
            {
                int num = class2.Int2[i];
                int num2 = class2.Int3[i];
                int num3 = class2.Int4[i];
        ...
        public override object vmethod_0(OggClass5 class490, OggClass3 class380)
        {
            ...
            if (class380.method_6(1) != 0)
            {
                ...
                for (int i = 0; i < @class.Int6; i++)
                {
                    int num = @class.Int7[i] = class380.method_6(smethod_0(class490.Int8));
                    int num2 = @class.Int8[i] = class380.method_6(smethod_0(class490.Int8));
        ...
        public override int vmethod_3(OggClass6 class710, object object2)
        {
            ...
            lock (_object0)
            {
                OggClass1 class66 = class710.OggClass1;
                OggClass5 class49 = class66.OggClass5;
                Class55 @class = (Class55) object2;
                Class54 class54 = @class.Class540;
                Class27 class27 = @class.Class270;
                int num = class710.Int3 = class49.Int13[class710.Int1];
                float[] array = class66.Float2[class710.Int1][class710.Int0][class710.Int2][class27.Int1];
                ...
                for (int i = 0; i < class49.Int8; i++)
                {
                    float[] array2 = class710.Float0[i];
                    int num2 = class54.Int1[i];
                ...
                for (int l = 0; l < class54.Int0; l++)
                {
                    int num3 = 0;
                    for (int m = 0; m < class49.Int8; m++)
                    {
                        if (class54.Int1[m] == l)
                        {
                            if (_int1[m] != 0)
                ...
                for (int n = class54.Int6 - 1; n >= 0; n--)
                {
                    float[] array3 = class710.Float0[class54.Int7[n]];
                    float[] array4 = class710.Float0[class54.Int8[n]];
                ...
                for (int num7 = 0; num7 < class49.Int8; num7++)
                {
                    float[] array5 = class710.Float0[num7];
                    int num8 = class54.Int1[num7];
                    @class.Class280[num8].vmethod_4(class710, @class.Object1[num8], _object1[num7], array5);
                }
                for (int num9 = 0; num9 < class49.Int8; num9++)
                {
                    float[] array6 = class710.Float0[num9];
                    ((Class68) class66.Object0[class710.Int1][0]).method_1(array6, array6);
                }
                for (int num10 = 0; num10 < class49.Int8; num10++)
                {
                    float[] array7 = class710.Float0[num10];
                    if (_int1[num10] != 0)
                    {
