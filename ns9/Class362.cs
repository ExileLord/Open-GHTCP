...
namespace ns9
{
	...
	{
		public Dictionary<string, Track<int, Class364>> dictionary_0 = new Dictionary<string, Class228<int, Class364>>();

		public Dictionary<string, Track<int, int[]>> dictionary_1 = new Dictionary<string, Class228<int, int[]>>();

		public Dictionary<string, Track<int, int[]>> dictionary_2 = new Dictionary<string, Class228<int, int[]>>();
		...
		public Class362(GH3Song gh3Song_1) : this()
		{
			this.gh3Song_0 = gh3Song_1;
		}

		public Class362(string string_0)
		{
			...
			while ((text2 = streamReader.ReadLine()) != null)
			{
				...
				else if (!text2.Equals("{"))
				{
					if (text2.Equals("}"))
					{
						...
						if (Class369.dictionary_0.TryGetValue(key, out num))
						{
							...
							using (List<string>.Enumerator enumerator5 = list.GetEnumerator())
							{
								while (enumerator5.MoveNext())
								{
									...
									{
										this.class228_0.Add(Convert.ToInt32(array4[0]), new int[]
										{
							...
							using (List<string>.Enumerator enumerator7 = list.GetEnumerator())
							{
								while (enumerator7.MoveNext())
								{
									...
									{
										this.class228_4.Add(Convert.ToInt32(array6[0]), Convert.ToInt32(array6[2]));
									}
								}
								goto IL_A3C;
							}
						...
						{
							Track<int, Class364> @class = new Track<int, Class364>();
								...
								if ((a7 = array8[1]) != null)
								{
									if (!(a7 == "N"))
									{
										if (!(a7 == "S"))
										{
											if (a7 == "B")
											{
												class3.Add(Convert.ToInt32(array8[0]), new int[]
												{
										...
										{
											class2.Add(Convert.ToInt32(array8[0]), new int[]
											{
												Convert.ToInt32(array8[3]),
												Convert.ToInt32(array8[2])
											});
									...
									{
										@class.Add(Convert.ToInt32(array8[0]), new Class364(Convert.ToInt32(array8[2]), Convert.ToInt32(array8[3])));
									}
								}
							}
							this.dictionary_0.Add(text, @class);
							this.dictionary_1.Add(text, class2);
							this.dictionary_2.Add(text, class3);
							goto IL_A3C;
						}
						goto IL_A3C;
					}
		...
		public Class362(string string_0, Class308 class308_0) : this(string_0, class308_0, null)
		{
		}

		public Class362(string string_0, Class308 class308_0, Class308 class308_1) : this(string_0, class308_0, class308_1, null)
		{
		}

		public Class362(string string_0, Class308 class308_0, Class308 class308_1, Class308 class308_2)
		{
			...
			for (int i = 0; i < array2.Length; i++)
			{
				...
				for (int j = 0; j < array3.Length; j++)
				{
					...
					for (int k = 0; k < array4.Length; k++)
					{
						...
						{
							Track<int, Class364> class2 = new Track<int, Class364>();
							int[] array5 = @class.method_7().method_7<int>();
							for (int l = 0; l < array5.Length; l += 3)
							{
								class2.Add(array5[l], new Class364(array5[l + 2], array5[l + 1]));
							}
							this.dictionary_0.Add(text3, class2);
						}
						...
						if (@class != null && @class.method_7() is Class291)
						{
							...
							this.dictionary_1.Add(text3, class3);
						}
						...
						if (@class != null && @class.method_7() is Class291)
						{
							...
							this.dictionary_2.Add(text3, class4);
						}
					}
				}
			}
			...
			if (@class != null && @class.method_7() is Class291)
			{
				...
				{
					this.class228_4.Add(current5[0], current5[1]);
				}
			}
			...
			if (@class != null && @class.method_7() is Class291)
			{
				...
				{
					this.class228_0.Add(current7[0], new int[]
					{
						current7[1],
						current7[2]
					});
		...
		private int method_0(int int_2)
		{
			...
			return Convert.ToInt32((num + (int_2 - this.class228_6.Keys[num]) / this.class228_6.Values[num]) * this.int_1);
		}
		...
		public ChartParser method_2(GH3Song gh3Song_1)
		{
			...
			if (gh3Song_1 != null)
			{
				@class.gh3Song_0.vmethod_0(gh3Song_1);
			}
			...
			if (this.class239_0 != null)
			{
				...
				for (int i = 1; i < this.class239_0.Count; i++)
				{
					...
					if (num3 != num)
					{
						@class.class363_0.class228_1.Add((i - 1) * this.int_1, num3);
						num = num3;
					}
					this.class228_6.Add(this.class239_0[i - 1], num2);
				}
				this.class239_0[0] = value;
				@class.class368_0.class228_0.Add(this.method_0(this.class239_0[this.class239_0.Count - 1]), new List<string>(new string[]
				{
					"end"
				}));
				foreach (int current in this.class228_1.Keys)
				{
					@class.class368_0.class228_1.Add(this.method_0(current), this.class228_1[current]);
				}
				foreach (int current2 in this.class228_0.Keys)
				{
					@class.class363_0.class228_0.Add(this.method_0(current2), this.class228_0[current2][0]);
				}
				Track<int, int> class2 = new Track<int, int>();
				Track<int, int> class3 = new Track<int, int>();
				...
				foreach (int current5 in this.class228_4.Keys)
				{
					int num4 = this.method_0(current5);
					int num5 = this.method_0(current5 + this.class228_4[current5] - this.int_0) - num4;
				...
				for (int j = 0; j < array2.Length; j++)
				{
					...
					for (int k = 0; k < array3.Length; k++)
					{
						...
						for (int l = 0; l < array4.Length; l++)
						{
							...
							{
								Class366 class6 = new Class366();
								Track<int, Class364> class7 = this.dictionary_0[key];
								foreach (int current7 in class7.Keys)
								{
									int num4 = this.method_0(current7);
									int num5 = this.method_0(current7 + class7[current7].int_0 - this.int_0) - num4;
									class6.class228_0.Add(num4, new Class364(class7[current7].bool_0, (num5 <= this.int_1 / 4) ? 0 : num5));
								}
								class6.bool_0 = false;
								if (this.dictionary_1.ContainsKey(key))
								{
									Track<int, int[]> class8 = this.dictionary_1[key];
								...
								{
									Track<int, int[]> class9 = this.dictionary_1[key];
								...
								@class.dictionary_0.Add(text3 + text + text2, class6);
							}
						}
					}
				}
		...
		public void method_3(string string_0)
		{
			...
			streamWriter.WriteLine("{");
			foreach (int current in this.class228_0.Keys)
			{
				streamWriter.WriteLine(string.Concat(new object[]
				{
					...
					current,
					" = TS ",
					this.class228_0[current][0],
					" ",
					this.class228_0[current][1]
				}));
			}
			streamWriter.WriteLine("}");
			...
			for (int i = 0; i < array.Length; i++)
			{
				...
				for (int j = 0; j < array2.Length; j++)
				{
					...
					Track<int, Class364> @class = this.dictionary_0.ContainsKey(text) ? this.dictionary_0[text] : new Track<int, Class364>();
					Track<int, int[]> class2 = this.dictionary_1.ContainsKey(text) ? this.dictionary_1[text] : new Track<int, int[]>();
					Track<int, int[]> class3 = this.dictionary_2.ContainsKey(text) ? this.dictionary_2[text] : new Track<int, int[]>();
			...
			streamWriter.WriteLine("{");
			foreach (int current7 in this.class228_4.Keys)
			{
				streamWriter.WriteLine(string.Concat(new object[]
				{
					"\t",
		...
		public Class308 method_4(string string_0)
		{
			...
			for (int i = 0; i < array.Length; i++)
			{
				...
				for (int j = 0; j < array2.Length; j++)
				{
					...
					if (this.dictionary_0.ContainsKey(text))
					{
						this.method_5(int_, string_0 + "_song_" + text, @class, this.dictionary_0[text]);
					}
					else
					{
					...
					{
						this.method_6(int_, string_0 + "_" + text + "_star", @class, this.dictionary_1[text]);
					}
					else
					{
					...
					{
						this.method_6(int_, string_0 + "_" + text + "_starbattlemode", @class, this.dictionary_2[text]);
					}
					else
					{
			...
			this.method_7(int_, string_0 + "_bossbattlep1", @class, this.class228_4);
		...
		private void method_5(int int_2, string string_0, Class308 class308_0, Track<int, Class364> class228_7)
		{
			...
			{
				list.Add(current);
				list.Add(class228_7[current].int_0);
