                ...
                case 3:
                    for (int l = 0; l < sourceSize; l++)
                    {
                        destination[l + offset] =
                            source[l] +
                            ((destination[l + offset - 1] - destination[l + offset - 2] << 1) +
                             (destination[l + offset - 1] - destination[l + offset - 2])) + destination[l + offset - 3];
                    }
                    return;
                case 4:
                    for (int m = 0; m < sourceSize; m++)
                    {
                        destination[m + offset] =
                            ...
                            ((destination[m + offset - 2] << 2) + (destination[m + offset - 2] << 1)) -
                            destination[m + offset - 4];
                    }
                    return;
                default:
                    return;
