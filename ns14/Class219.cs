...
namespace ns14
{
	public class ImageRelatedClass
	{
		...
		public void method_5(bool bool2)
		{
			...
			if (_bitmap0 == null)
			{
				_bitmap0 = new Bitmap(method_0(), method_1(), _bool1 ? PixelFormat.Format32bppArgb : PixelFormat.Format24bppRgb);
				_bitmapData0 = method_3().LockBits(new Rectangle(0, 0, method_0(), method_1()), ImageLockMode.ReadWrite, method_3().PixelFormat);
				_intptr0 = _bitmapData0.Scan0;
			}
			if (bool2)
			{
