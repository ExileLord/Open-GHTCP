...
namespace GHNamespace6
{
    ...
    {
        public static void smethod_0(IEnumerable<string> fileNameList, string saveLocation, string password,
            Stream[] fileStreamList)
        {
            CheckFileDirectory(fileNameList, saveLocation, 9, password, fileStreamList);
        }

        public static void CheckFileDirectory(IEnumerable<string> fileNameList, string saveLocation, int nine,
