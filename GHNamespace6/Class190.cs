...
namespace GHNamespace6
{
    public class Class190
    {
        private class Class191
        {
            ...
            {
                int[] array = new int[_int3];
                int num = 0;
                _short1 = new short[Short0.Length];
                for (int i = 0; i < _int3; i++)
                {
                    array[i] = num;
                    num += _int2[i] << 15 - i;
                }
            ...
            public void method_6(Class191 class1910)
            {
                ...
                while (i < Int1)
                {
                    ...
                    else
                    {
                        ...
                        if (num != num3)
                        {
                            short[] expr_3BCp0 = class1910.Short0;
                            int expr_3BCp1 = num3;
                    ...
                    if (num2 < num5)
                    {
                        short[] expr_8CCp0 = class1910.Short0;
                        int expr_8CCp1 = num;
                        expr_8CCp0[expr_8CCp1] += (short) num2;
                    }
                    else if (num != 0)
                    {
                        short[] exprAdCp0 = class1910.Short0;
                        int exprAdCp1 = 16;
                        exprAdCp0[exprAdCp1] += 1;
                    }
                    else if (num2 <= 10)
                    {
                        short[] exprCfCp0 = class1910.Short0;
                        int exprCfCp1 = 17;
                        exprCfCp0[exprCfCp1] += 1;
                    }
                    else
                    {
                        short[] exprEcCp0 = class1910.Short0;
                        int exprEcCp1 = 18;
            ...
            private void method_8(int[] int4)
            {
                ...
                _int2[_int3 - 2] -= num3;
                int num7 = 2 * num2;
                for (int num8 = _int3; num8 != 0; num8--)
                {
                    int k = _int2[num8 - 1];
                    while (k > 0)
                    {
                        int num9 = 2 * int4[num7++];
                        if (int4[num9 + 1] == -1)
                        {
        ...
        {
            short[] expr15Cp0 = _class1910.Short0;
            int expr15Cp1 = 256;
            ...
            int num2 = 14 + num * 3 + _class1912.method_5() + _class1910.method_5() + _class1911.method_5() + _int2;
            int num3 = _int2;
            for (int j = 0; j < 286; j++)
            {
        ...
        public bool method_6(int int3)
        {
            ...
            short[] expr39Cp0 = _class1910.Short0;
            expr39Cp0[int3] += 1;
            return method_5();
        }
        ...
        public bool method_7(int int3, int int4)
        {
            ...
            int num = smethod_1(int4 - 3);
            short[] expr45Cp0 = _class1910.Short0;
            int expr45Cp1 = num;
            ...
            int num2 = smethod_2(int3 - 1);
            short[] expr93Cp0 = _class1911.Short0;
            int expr93Cp1 = num2;
