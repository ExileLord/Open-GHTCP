...
namespace ns18
{
	public abstract class Class259 : Class258, IComparable
	{
		public Class259 method_1()
		{
			return (Class259)base.Parent;
		}
		...
		public Class258 method_2(int int_0)
		{
			return (Class258)base.Nodes[int_0];
		}

		public int method_3(Class258 class258_0)
		{
			return base.Nodes.Add(class258_0);
		}

		public virtual Class259 vmethod_12(int int_0)
		{
		...
		public T method_5<T>(T gparam_0) where T : Class259
		{
			if (this.CompareTo(gparam_0) == 0)
			{
				return (T)((object)this);
			}
			if (base.Nodes.Count != 0 && base.Nodes[0] is Class259)
			{
				...
				try
				{
					...
					{
						Class259 @class = (Class259)enumerator.Current;
						T t;
		...
		public bool method_6<T>(ref T gparam_0) where T : Class259
		{
			if (this.CompareTo(gparam_0) == 0)
			{
