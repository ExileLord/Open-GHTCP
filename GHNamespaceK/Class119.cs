...
namespace GHNamespaceK
{
    public static class Class119
    {
        ...
        [SuppressUnmanagedCodeSecurity]
        [DllImport("openal32.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "alSourceQueueBuffers",
            ExactSpelling = true)]
        ...
        public static Enum12 smethod_10(WaveFormat waveFormat0)
        {
            ...
            throw new NotSupportedException(string.Concat("OpenAL does not support this format: ",
                waveFormat0.waveFormatTag_0, " | ", (int) waveFormat0.waveFormatTag_0));
        }
    }
}