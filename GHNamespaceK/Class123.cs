...
namespace GHNamespaceK
{
    public class Class123 : Class121
    {
        ...
        {
            return string.Concat("Picture:  Type=", _int0, " MIME type=", _string0, " Description=\"", _string1,
                "\" Pixels (WxH)=", _int3, "x", _int4, " Color Depth=", _int5, " Color Count=", _int6,
                " Picture Size (bytes)=", _int7);
        }
    }
}