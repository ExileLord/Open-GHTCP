...
namespace ns21
{
	public class IntegerRootNode : Class268
	{
		...
		public IntegerRootNode(string string_0) : this(QbSongClass1.smethod_9(string_0))
		{
		}
		...
		public IntegerRootNode(string string_0, string string_1, int int_2) : this(QbSongClass1.smethod_9(string_0), QbSongClass1.smethod_9(string_1), int_2)
		{
		}
