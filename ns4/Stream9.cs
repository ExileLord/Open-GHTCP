...
namespace ns4
{
	public class Stream9 : Stream1
	{
		...
		public override long Position
		{
			...
			set
			{
				lock (this.object_0)
				{
					...
					{
						this.stream_0.Position = (long)(this.int_2 + this.class83_0.method_0((double)value / (double)this.long_0));
					}
					else
					{
		...
		public Stream9(string string_0) : this(File.OpenRead(string_0))
		{
		}

		public Stream9(Stream stream_1) : this(stream_1, Enum4.const_0, 4096)
		{
		}

		public Stream9(Stream stream_1, Enum4 enum4_0) : this(stream_1, enum4_0, 4096)
		{
		}

		public Stream9(Stream stream_1, Enum4 enum4_0, int int_5)
		{
			this.class81_0 = new Class81(new Class104(enum4_0));
			this.stream_0 = stream_1;
			this.class82_0 = new Class82(this.stream_0, int_5);
			...
			{
				this.long_0 = Convert.ToInt64(this.class107_0.method_18((int)(this.stream_0.Length - (long)this.int_2)) * ((double)this.waveFormat_0.int_0 * ((double)this.waveFormat_0.short_1 / 1000.0)));
				this.class83_0 = this.class107_0.method_11();
				if (this.class83_0 != null && this.class83_0.int_2 == -1)
				{
					this.class83_0.int_2 = (int)(this.stream_0.Length - (long)this.int_2);
				}
			}
			if (this.long_0 <= 0L)
			{
