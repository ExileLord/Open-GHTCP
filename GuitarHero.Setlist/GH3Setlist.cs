...
namespace GuitarHero.Setlist
{
	...
	public class Gh3Setlist
	{
		...
		public void method_5(StructureHeaderNode class2860, Gh3Songlist gh3Songlist0)
		{
			...
			Prefix = (((@class = class2860.method_5(new AsciiStructureNode("prefix"))) != null) ? @class.method_8() : "general");
			InitialMovie = (((@class = class2860.method_5(new AsciiStructureNode("initial_movie"))) != null) ? @class.method_8() : "");
			IntegerStructureNode class2;
			var num = ((class2 = class2860.method_5(new IntegerStructureNode("num_tiers"))) != null) ? class2.method_8() : 0;
			try
			{
				for (var i = 1; i <= num; i++)
				{
					Tiers.Add(new Gh3Tier(class2860.method_5(new StructurePointerNode("tier" + i)).method_8(), gh3Songlist0));
				}
			}
			catch
			{
