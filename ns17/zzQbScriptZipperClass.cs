...
namespace ns17
{
	public static class ZzQbScriptZipperClass
	{
		...
		{
			return ZipManager.smethod_5(KeyGenerator.CryptoMethod(Assembly.GetExecutingAssembly().GetManifestResourceStream(string.Concat("GHTCP.FileDB.QBS.", GameName, '.', string1)), "MinimizedScript1f2g4h"), string1 + ".qbs");
		}
		...
		{
			return ZipManager.smethod_5(KeyGenerator.CryptoMethod(Assembly.GetExecutingAssembly().GetManifestResourceStream("GHTCP.FileDB.QB." + string1), "MinimizedQBFile4f4g9h"), string1 + ".qb");
		}
