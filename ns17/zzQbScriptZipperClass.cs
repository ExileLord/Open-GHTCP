...
namespace ns17
{
	public static class zzQbScriptZipperClass
	{
		...
		{
			return ZIPManager.smethod_5(KeyGenerator.cryptoMethod(Assembly.GetExecutingAssembly().GetManifestResourceStream(string.Concat("GHTCP.FileDB.QBS.", GameName, '.', string_1)), "MinimizedScript1f2g4h"), string_1 + ".qbs");
		}

		public static void smethod_1(ScriptRootNode class274_0)
		{
			class274_0.method_7().method_7(smethod_0(QbSongClass1.GetDictString(class274_0.int_0)));
		}
		...
		{
			return new zzGenericNode1(string_1, smethod_2(string_1));
		}
	}
}
