...
namespace ns17
{
	public static class Class372
	{
		...
		{
			return Class199.smethod_5(Class244.smethod_5(Assembly.GetExecutingAssembly().GetManifestResourceStream(string.Concat(new object[]
			{
				"GHTCP.FileDB.QBS.",
				Class372.string_0,
				'.',
		...
		{
			return Class199.smethod_5(Class244.smethod_5(Assembly.GetExecutingAssembly().GetManifestResourceStream("GHTCP.FileDB.QB." + string_1), "MinimizedQBFile4f4g9h"), string_1 + ".qb");
		}
