...
namespace ns3
{
	public class Stream7 : Stream1
	{
		...
		private readonly Class71 class71_0;
		...
		private Stream7()
		{
			...
			this.class71_0 = new Class71(this.class66_0);
		}

		public Stream7(string string_0) : this()
		{
			FileStream stream_ = null;
			try
			{
				stream_ = new FileStream(string_0, FileMode.Open, FileAccess.Read);
			}
			catch (Exception ex)
			{
				throw new Exception0("OggStream: " + ex.Message);
			}
			int num = this.method_9(stream_, null, 0);
			if (num == -1)
			{
		...
		public Stream7(Stream stream_1) : this(stream_1, null, 0)
		{
		}

		public Stream7(Stream stream_1, byte[] byte_0, int int_24) : this()
		{
		...
		private int method_0(Class48 class48_0, long long_6)
		{
			...
			while (long_6 <= 0L || this.long_0 < long_6)
			{
				...
				else
				{
					...
					if (long_6 == 0L)
					{
						return Stream7.int_6;
					}
					int num2 = this.method_7();
					if (num2 == 0)
					{
						return Stream7.int_7;
					}
					if (num2 < 0)
					{
						return Stream7.int_9;
					}
				}
			}
			return Stream7.int_6;
		...
		private int method_1(Class48 class48_0)
		{
			...
			while (num2 == -1)
			{
				num -= (long)Stream7.int_2;
				if (num < 0L)
				{
					num = 0L;
				}
				this.method_8(num);
				while (this.long_0 < num + (long)Stream7.int_2)
				{
					num3 = this.method_0(class48_0, num + (long)Stream7.int_2 - this.long_0);
					if (num3 == Stream7.int_9)
					{
						return Stream7.int_9;
					}
					if (num3 < 0)
			...
			num3 = this.method_0(class48_0, (long)Stream7.int_2);
			if (num3 < 0)
			{
				return Stream7.int_10;
			}
			return num2;
		}

		private int method_2(Class49 class49_1, Class47 class47_1, int[] int_24, Class48 class48_0)
		{
			Class48 @class = new Class48();
			Class67 class67_ = new Class67();
			if (class48_0 == null)
			{
				int num = this.method_0(@class, (long)Stream7.int_2);
				if (num == Stream7.int_9)
				{
					return Stream7.int_9;
				}
				if (num < 0)
				{
					return Stream7.int_13;
				}
				class48_0 = @class;
			}
			if (int_24 != null)
			...
			while (i < 3)
			{
				...
				while (i < 3)
				{
					...
					if (class49_1.method_4(class47_1, class67_) != 0)
					{
		...
		private void method_3(Class49 class49_1, Class47 class47_1, int int_24)
		{
			Class48 @class = new Class48();
			this.class49_0 = new Class49[this.int_20];
			...
			while (i < this.int_20)
			{
				...
				else
				{
					...
					if (this.method_2(this.class49_0[i], this.class47_0[i], null, null) == -1)
					{
		...
		private int method_4()
		{
			...
			this.class66_0.method_1(this.class49_0[0]);
			this.class71_0.method_0(this.class66_0);
			this.bool_1 = true;
			return 0;
		}
		...
		private int method_6(int int_24)
		{
			...
			while (true)
			{
				if (this.bool_1)
				{
					...
					{
						num2 = class2.long_0;
						if (this.class71_0.method_2(class2) == 0)
						{
							goto Block_11;
						}
					}
				...
				if (!this.bool_1)
				{
					...
					{
						int[] array = new int[1];
						int num4 = this.method_2(this.class49_0[0], this.class47_0[0], array, @class);
						this.int_22 = array[0];
						if (num4 != 0)
						{
							return num4;
			...
			return -1;
			Block_11:
			int num5 = this.class66_0.method_3();
			this.class66_0.method_2(this.class71_0);
			this.float_1 += (float)(this.class66_0.method_3() - num5);
			this.float_0 += (float)(class2.int_1 * 8);
			if (num2 != -1L && class2.int_3 == 0)
			{
				int num6 = this.bool_0 ? this.int_23 : 0;
				int num7 = this.class66_0.method_3();
				num2 -= (long)num7;
		...
		private static int smethod_0(Stream stream_1, long long_6, int int_24)
		{
			if (stream_1.CanSeek)
			{
				try
				{
					if (int_24 == Stream7.int_3)
					{
						stream_1.Seek(long_6, SeekOrigin.Begin);
					}
					else if (int_24 == Stream7.int_5)
					{
		...
		{
			int offset = this.class52_0.method_1(Stream7.int_2);
			byte[] byte_ = this.class52_0.byte_0;
			int num = 0;
			int result;
			try
			{
				num = this.stream_0.Read(byte_, offset, Stream7.int_2);
				goto IL_51;
			}
			catch (Exception ex)
			{
				Console.Error.WriteLine(ex.Message);
				result = Stream7.int_9;
			}
			return result;
			IL_51:
		...
		{
			Stream7.smethod_0(this.stream_0, long_6, Stream7.int_3);
			this.long_0 = long_6;
			this.class52_0.method_4();
		}

		private int method_9(Stream stream_1, byte[] byte_0, int int_24)
		{
			return this.method_10(stream_1, byte_0, int_24);
		}

		private int method_10(Stream stream_1, byte[] byte_0, int int_24)
		{
			this.stream_0 = stream_1;
			this.class52_0.method_5();
			if (byte_0 != null)
			{
				int dstOffset = this.class52_0.method_1(int_24);
				Buffer.BlockCopy(byte_0, 0, this.class52_0.byte_0, dstOffset, int_24);
				this.class52_0.method_2(int_24);
			}
			int num = stream_1.CanSeek ? this.method_11() : this.method_12();
			Class49 @class = this.method_21(-1);
		...
		{
			Class49 class49_ = new Class49();
			Class47 class47_ = new Class47();
			Class48 @class = new Class48();
			int[] array = new int[1];
			int num = this.method_2(class49_, class47_, array, null);
			int num2 = array[0];
			...
			this.bool_0 = true;
			Stream7.smethod_0(this.stream_0, 0L, Stream7.int_5);
			this.long_0 = Stream7.smethod_1(this.stream_0);
			...
			this.method_3(class49_, class47_, int_);
		...
		private int method_12()
		{
			this.int_20 = 1;
			this.class49_0 = new Class49[this.int_20];
			this.class49_0[0] = new Class49();
			this.class47_0 = new Class47[this.int_20];
			this.class47_0[0] = new Class47();
			int[] array = new int[1];
			if (this.method_2(this.class49_0[0], this.class47_0[0], array, null) == -1)
			{
				return -1;
			}
			this.int_22 = array[0];
		...
		private int method_13(long long_6, long long_7, long long_8, int int_24, int int_25)
		{
			...
			{
				long num2;
				if (num - long_7 < (long)Stream7.int_2)
				{
					num2 = long_7;
				}
				else
		...
		public float method_16(int int_24)
		{
			...
			return (float)this.long_3[int_24] / (float)this.class49_0[int_24].int_9;
		}
		...
		public int method_18(long long_6)
		{
			...
			{
				long num5;
				if (num3 - num4 < (long)Stream7.int_2)
				{
					num5 = num4;
				}
				else
			...
			while (this.long_4 < long_6)
			{
				...
				int num9 = this.class66_0.method_3();
				if (num9 > num8)
				{
					num9 = num8;
				}
				this.class66_0.method_6(num9);
		...
		public int method_20(int int_24)
		{
			...
			if (this.class49_0[int_24].int_11 > 0)
			{
				return this.class49_0[int_24].int_11;
			}
			if (this.class49_0[int_24].int_10 <= 0)
			{
				return -1;
			}
			if (this.class49_0[int_24].int_12 > 0)
			{
				return (this.class49_0[int_24].int_10 + this.class49_0[int_24].int_12) / 2;
			}
			return this.class49_0[int_24].int_10;
		}

		public Class49 method_21(int int_24)
		{
			if (this.bool_0)
			{
				if (int_24 < 0)
				{
					...
					return this.class49_0[this.int_23];
				}
				else
				{
					if (int_24 >= this.int_20)
		...
		private int method_22()
		{
			...
			this.class66_0.method_7();
			this.class56_0.method_2();
			if (this.class49_0 != null && this.int_20 != 0)
			{
				for (int i = 0; i < this.int_20; i++)
				{
					this.class49_0[i].method_1();
		...
		public override int vmethod_4(float[] float_2, int int_24, int int_25)
		{
			...
			do
			{
				if (this.bool_1)
				{
					int num3 = this.class66_0.method_4(float_2, num, num2);
					if (num3 != 0)
					{
						this.class66_0.method_6(num3);
		...
		public override float[][] vmethod_5(int int_24)
		{
			...
			do
			{
				if (this.bool_1)
				{
					int num2 = this.class66_0.method_5(array, num, int_24);
					if (num2 != 0)
					{
						num += num2;
						this.long_4 += (long)num2;
						this.class66_0.method_6(num2);
						if (num >= int_24)
						{
							break;
						}
