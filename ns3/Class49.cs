...
namespace ns3
{
	public class Class49
	{
		...
		public void method_1()
		{
			...
			{
				if (this.class65_0[n] != null)
				{
					this.class65_0[n].method_2();
					this.class65_0[n] = null;
				}
			}
			this.class65_0 = null;
		...
		private int method_2(Class38 class38_0)
		{
			this.int_7 = class38_0.method_6(32);
			if (this.int_7 != 0)
			{
				return -1;
			}
			this.int_8 = class38_0.method_6(8);
			this.int_9 = class38_0.method_6(32);
			this.int_10 = class38_0.method_6(32);
			this.int_11 = class38_0.method_6(32);
			this.int_12 = class38_0.method_6(32);
			this.int_13[0] = 1 << class38_0.method_6(4);
			this.int_13[1] = 1 << class38_0.method_6(4);
		...
		private int method_3(Class38 class38_0)
		{
			this.int_19 = class38_0.method_6(8) + 1;
			if (this.class65_0 == null || this.class65_0.Length != this.int_19)
			{
				this.class65_0 = new Class65[this.int_19];
			}
			for (int i = 0; i < this.int_19; i++)
			{
				this.class65_0[i] = new Class65();
				if (this.class65_0[i].method_0(class38_0) != 0)
				{
					this.method_1();
					return -1;
				}
			}
			this.int_16 = class38_0.method_6(6) + 1;
			...
			{
				this.int_22[j] = class38_0.method_6(16);
				if (this.int_22[j] < 0 || this.int_22[j] >= Class49.int_2)
				{
					this.method_1();
					return -1;
				}
				this.object_1[j] = Class50.class50_0[this.int_22[j]].vmethod_0(this, class38_0);
			...
			this.int_17 = class38_0.method_6(6) + 1;
			...
			{
				this.int_23[k] = class38_0.method_6(16);
				if (this.int_23[k] < 0 || this.int_23[k] >= Class49.int_3)
				{
					this.method_1();
					return -1;
				}
				this.object_2[k] = Class28.class28_0[this.int_23[k]].vmethod_0(this, class38_0);
			...
			this.int_18 = class38_0.method_6(6) + 1;
			...
			{
				this.int_24[l] = class38_0.method_6(16);
				if (this.int_24[l] < 0 || this.int_24[l] >= Class49.int_4)
				{
					this.method_1();
					return -1;
				}
				this.object_3[l] = Class23.class23_0[this.int_24[l]].vmethod_0(this, class38_0);
			...
			this.int_15 = class38_0.method_6(6) + 1;
			...
			{
				this.int_21[m] = class38_0.method_6(16);
				if (this.int_21[m] < 0 || this.int_21[m] >= Class49.int_5)
				{
					this.method_1();
					return -1;
				}
				this.object_0[m] = Class34.class34_0[this.int_21[m]].vmethod_0(this, class38_0);
			...
			this.int_14 = class38_0.method_6(6) + 1;
			...
			for (int n = 0; n < this.int_14; n++)
			{
				...
				this.class27_0[n].int_0 = class38_0.method_6(1);
				this.class27_0[n].int_1 = class38_0.method_6(16);
				this.class27_0[n].int_2 = class38_0.method_6(16);
				this.class27_0[n].int_3 = class38_0.method_6(8);
				if (this.class27_0[n].int_1 >= Class49.int_6 || this.class27_0[n].int_2 >= Class49.int_6 || this.class27_0[n].int_3 >= this.int_15)
				{
					this.method_1();
					return -1;
				}
