...
namespace ns16
{
	...
	public class Class236<T> : IEnumerable, ICollection<T>, IEnumerable<T>
	{
		...
		public struct Struct82 : IEnumerator, IEnumerator<T>, IDisposable
		{
			...
			public Struct82(Class236<T> class236_1)
			{
				this = default(Class236<T>.Struct82);
		...
		private static class Class237
		{
			...
			{
				for (int i = (int_1 & -2) - 1; i < 2147483647; i += 2)
				{
					if (Class236<T>.Class237.smethod_0(i))
					{
						return i;
					}
				}
			...
			{
				for (int i = 0; i < Class236<T>.Class237.int_0.Length; i++)
				{
					if (int_1 <= Class236<T>.Class237.int_0[i])
					{
						return Class236<T>.Class237.int_0[i];
					}
				}
				return Class236<T>.Class237.smethod_1(int_1);
			}
		}

		private int[] int_0;

		private Class236<T>.Struct81[] struct81_0;
		...
		public Class236(IEqualityComparer<T> iequalityComparer_1)
		{
			this.method_0(10, iequalityComparer_1);
		}

		public Class236(IEnumerable<T> ienumerable_0) : this(ienumerable_0, null)
		{
		}

		public Class236(IEnumerable<T> ienumerable_0, IEqualityComparer<T> iequalityComparer_1)
		{
		...
		private void method_1(int int_6)
		{
			...
			this.struct81_0 = new Class236<T>.Struct81[int_6];
			this.int_2 = -1;
		...
		{
			int num = Class236<T>.Class237.smethod_2(this.int_0.Length << 1 | 1);
			int[] array = new int[num];
			Class236<T>.Struct81[] array2 = new Class236<T>.Struct81[num];
		...
		public bool Remove(T item)
		{
			...
			do
			{
				Class236<T>.Struct81 @struct = this.struct81_0[num3];
				if (@struct.int_0 == num)
				{
		...
		{
			return new Class236<T>.Struct82(this);
		}
